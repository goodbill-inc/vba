  ...
  class UserApi
    ...
    def admin_disable_user_with_http_info(vbasoftware_database, user_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: UserApi.admin_disable_user ...'
      end
      # verify the required parameter 'vbasoftware_database' is set
      if @api_client.config.client_side_validation && vbasoftware_database.nil?
        fail ArgumentError, "Missing the required parameter 'vbasoftware_database' when calling UserApi.admin_disable_user"
      end
      # verify the required parameter 'user_id' is set
      if @api_client.config.client_side_validation && user_id.nil?
        fail ArgumentError, "Missing the required parameter 'user_id' when calling UserApi.admin_disable_user"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"UserApi.admin_disable_user",
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: UserApi#admin_disable_user\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    def admin_enable_user_with_http_info(vbasoftware_database, user_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: UserApi.admin_enable_user ...'
      end
      # verify the required parameter 'vbasoftware_database' is set
      if @api_client.config.client_side_validation && vbasoftware_database.nil?
        fail ArgumentError, "Missing the required parameter 'vbasoftware_database' when calling UserApi.admin_enable_user"
      end
      # verify the required parameter 'user_id' is set
      if @api_client.config.client_side_validation && user_id.nil?
        fail ArgumentError, "Missing the required parameter 'user_id' when calling UserApi.admin_enable_user"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"UserApi.admin_enable_user",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: UserApi#admin_enable_user\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def admin_resend_confirmation_code_with_http_info(vbasoftware_database, user_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: UserApi.admin_resend_confirmation_code ...'
      end
      # verify the required parameter 'vbasoftware_database' is set
      if @api_client.config.client_side_validation && vbasoftware_database.nil?
        fail ArgumentError, "Missing the required parameter 'vbasoftware_database' when calling UserApi.admin_resend_confirmation_code"
      end
      # verify the required parameter 'user_id' is set
      if @api_client.config.client_side_validation && user_id.nil?
        fail ArgumentError, "Missing the required parameter 'user_id' when calling UserApi.admin_resend_confirmation_code"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"UserApi.admin_resend_confirmation_code",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: UserApi#admin_resend_confirmation_code\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def admin_resend_welcome_mesasge_with_http_info(vbasoftware_database, user_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: UserApi.admin_resend_welcome_mesasge ...'
      end
      # verify the required parameter 'vbasoftware_database' is set
      if @api_client.config.client_side_validation && vbasoftware_database.nil?
        fail ArgumentError, "Missing the required parameter 'vbasoftware_database' when calling UserApi.admin_resend_welcome_mesasge"
      end
      # verify the required parameter 'user_id' is set
      if @api_client.config.client_side_validation && user_id.nil?
        fail ArgumentError, "Missing the required parameter 'user_id' when calling UserApi.admin_resend_welcome_mesasge"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"UserApi.admin_resend_welcome_mesasge",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: UserApi#admin_resend_welcome_mesasge\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def confirm_forgot_password_with_http_info(vbasoftware_client_id, vbasoftware_client_code, vbasoftware_database, user_confirm_forgot_password_request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: UserApi.confirm_forgot_password ...'
      end
      ...
      if @api_client.config.client_side_validation && vbasoftware_client_id.nil?
        fail ArgumentError, "Missing the required parameter 'vbasoftware_client_id' when calling UserApi.confirm_forgot_password"
      end
      ...
      if @api_client.config.client_side_validation && vbasoftware_client_code.nil?
        fail ArgumentError, "Missing the required parameter 'vbasoftware_client_code' when calling UserApi.confirm_forgot_password"
      end
      # verify the required parameter 'vbasoftware_database' is set
      if @api_client.config.client_side_validation && vbasoftware_database.nil?
        fail ArgumentError, "Missing the required parameter 'vbasoftware_database' when calling UserApi.confirm_forgot_password"
      end
      ...
      if @api_client.config.client_side_validation && user_confirm_forgot_password_request.nil?
        fail ArgumentError, "Missing the required parameter 'user_confirm_forgot_password_request' when calling UserApi.confirm_forgot_password"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"UserApi.confirm_forgot_password",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: UserApi#confirm_forgot_password\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def create_users(vbasoftware_database, users, opts = {})
      data, _status_code, _headers = create_users_with_http_info(vbasoftware_database, users, opts)
      data
    end
    ...
    def create_users_with_http_info(vbasoftware_database, users, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: UserApi.create_users ...'
      end
      # verify the required parameter 'vbasoftware_database' is set
      if @api_client.config.client_side_validation && vbasoftware_database.nil?
        fail ArgumentError, "Missing the required parameter 'vbasoftware_database' when calling UserApi.create_users"
      end
      # verify the required parameter 'users' is set
      if @api_client.config.client_side_validation && users.nil?
        fail ArgumentError, "Missing the required parameter 'users' when calling UserApi.create_users"
      end
      # resource path
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(users)
      ...
      new_options = opts.merge(
        :operation => :"UserApi.create_users",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    # @param [Hash] opts the optional parameters
    # @return [nil]
    def delete_user(vbasoftware_database, user_id, opts = {})
      delete_user_with_http_info(vbasoftware_database, user_id, opts)
      nil
    end
    ...
    def delete_user_with_http_info(vbasoftware_database, user_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: UserApi.delete_user ...'
      end
      # verify the required parameter 'vbasoftware_database' is set
      if @api_client.config.client_side_validation && vbasoftware_database.nil?
        fail ArgumentError, "Missing the required parameter 'vbasoftware_database' when calling UserApi.delete_user"
      end
      # verify the required parameter 'user_id' is set
      if @api_client.config.client_side_validation && user_id.nil?
    ...
    def forgot_password_with_http_info(vbasoftware_client_id, vbasoftware_client_code, vbasoftware_database, user_forgot_password_request, opts = {})
      ...
      # verify the required parameter 'vbasoftware_client_id' is set
      if @api_client.config.client_side_validation && vbasoftware_client_id.nil?
        fail ArgumentError, "Missing the required parameter 'vbasoftware_client_id' when calling UserApi.forgot_password"
      end
      # verify the required parameter 'vbasoftware_client_code' is set
      if @api_client.config.client_side_validation && vbasoftware_client_code.nil?
        fail ArgumentError, "Missing the required parameter 'vbasoftware_client_code' when calling UserApi.forgot_password"
      end
      # verify the required parameter 'vbasoftware_database' is set
      if @api_client.config.client_side_validation && vbasoftware_database.nil?
        fail ArgumentError, "Missing the required parameter 'vbasoftware_database' when calling UserApi.forgot_password"
      end
      ...
      if @api_client.config.client_side_validation && user_forgot_password_request.nil?
        fail ArgumentError, "Missing the required parameter 'user_forgot_password_request' when calling UserApi.forgot_password"
      end
      # resource path
    ...
    # @param [Hash] opts the optional parameters
    # @return [UsersVBAResponse]
    def get_user(vbasoftware_database, user_id, opts = {})
      data, _status_code, _headers = get_user_with_http_info(vbasoftware_database, user_id, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(UsersVBAResponse, Integer, Hash)>] UsersVBAResponse data, response status code and response headers
    def get_user_with_http_info(vbasoftware_database, user_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: UserApi.get_user ...'
      end
      # verify the required parameter 'vbasoftware_database' is set
      if @api_client.config.client_side_validation && vbasoftware_database.nil?
        fail ArgumentError, "Missing the required parameter 'vbasoftware_database' when calling UserApi.get_user"
      end
      # verify the required parameter 'user_id' is set
      if @api_client.config.client_side_validation && user_id.nil?
    ...
    def list_users(vbasoftware_database, opts = {})
      data, _status_code, _headers = list_users_with_http_info(vbasoftware_database, opts)
      data
    end
    ...
    def list_users_with_http_info(vbasoftware_database, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: UserApi.list_users ...'
      end
      # verify the required parameter 'vbasoftware_database' is set
      if @api_client.config.client_side_validation && vbasoftware_database.nil?
        fail ArgumentError, "Missing the required parameter 'vbasoftware_database' when calling UserApi.list_users"
      end
      # resource path
      local_var_path = '/users'
    ...
    def refresh_user_tokens_with_http_info(vbasoftware_client_id, vbasoftware_client_code, vbasoftware_database, expired_id_token, refresh_token, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: UserApi.refresh_user_tokens ...'
      end
      # verify the required parameter 'vbasoftware_client_id' is set
      if @api_client.config.client_side_validation && vbasoftware_client_id.nil?
        fail ArgumentError, "Missing the required parameter 'vbasoftware_client_id' when calling UserApi.refresh_user_tokens"
      end
      # verify the required parameter 'vbasoftware_client_code' is set
      if @api_client.config.client_side_validation && vbasoftware_client_code.nil?
        fail ArgumentError, "Missing the required parameter 'vbasoftware_client_code' when calling UserApi.refresh_user_tokens"
      end
      # verify the required parameter 'vbasoftware_database' is set
      if @api_client.config.client_side_validation && vbasoftware_database.nil?
        fail ArgumentError, "Missing the required parameter 'vbasoftware_database' when calling UserApi.refresh_user_tokens"
      end
      # verify the required parameter 'expired_id_token' is set
      if @api_client.config.client_side_validation && expired_id_token.nil?
        fail ArgumentError, "Missing the required parameter 'expired_id_token' when calling UserApi.refresh_user_tokens"
      end
      # verify the required parameter 'refresh_token' is set
      if @api_client.config.client_side_validation && refresh_token.nil?
        fail ArgumentError, "Missing the required parameter 'refresh_token' when calling UserApi.refresh_user_tokens"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"UserApi.refresh_user_tokens",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: UserApi#refresh_user_tokens\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param vbasoftware_client_code [String] Client Code
    # @param vbasoftware_database [String] Target database
    # @param submit_mfa_code_request [SubmitMFACodeRequest] 
    # @param [Hash] opts the optional parameters
    # @option opts [String] :vbasoftware_machine_id Machine ID (optional)
    # @return [UserAuthenticationResponseVBAResponse]
    def submit_mfa_code(vbasoftware_client_id, vbasoftware_client_code, vbasoftware_database, submit_mfa_code_request, opts = {})
      data, _status_code, _headers = submit_mfa_code_with_http_info(vbasoftware_client_id, vbasoftware_client_code, vbasoftware_database, submit_mfa_code_request, opts)
      data
    end
    ...
    # @option opts [String] :vbasoftware_machine_id Machine ID (optional)
    # @return [Array<(UserAuthenticationResponseVBAResponse, Integer, Hash)>] UserAuthenticationResponseVBAResponse data, response status code and response headers
    def submit_mfa_code_with_http_info(vbasoftware_client_id, vbasoftware_client_code, vbasoftware_database, submit_mfa_code_request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: UserApi.submit_mfa_code ...'
      end
      # verify the required parameter 'vbasoftware_client_id' is set
      if @api_client.config.client_side_validation && vbasoftware_client_id.nil?
        fail ArgumentError, "Missing the required parameter 'vbasoftware_client_id' when calling UserApi.submit_mfa_code"
      end
      # verify the required parameter 'vbasoftware_client_code' is set
      if @api_client.config.client_side_validation && vbasoftware_client_code.nil?
        fail ArgumentError, "Missing the required parameter 'vbasoftware_client_code' when calling UserApi.submit_mfa_code"
      end
      # verify the required parameter 'vbasoftware_database' is set
      if @api_client.config.client_side_validation && vbasoftware_database.nil?
        fail ArgumentError, "Missing the required parameter 'vbasoftware_database' when calling UserApi.submit_mfa_code"
      end
      # verify the required parameter 'submit_mfa_code_request' is set
      if @api_client.config.client_side_validation && submit_mfa_code_request.nil?
        fail ArgumentError, "Missing the required parameter 'submit_mfa_code_request' when calling UserApi.submit_mfa_code"
      end
      # resource path
      local_var_path = '/mfa-submit-code'
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(submit_mfa_code_request)
      ...
      new_options = opts.merge(
        :operation => :"UserApi.submit_mfa_code",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: UserApi#submit_mfa_code\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def update_batch_users(vbasoftware_database, users, opts = {})
      data, _status_code, _headers = update_batch_users_with_http_info(vbasoftware_database, users, opts)
      data
    end
    ...
    def update_batch_users_with_http_info(vbasoftware_database, users, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: UserApi.update_batch_users ...'
      end
      # verify the required parameter 'vbasoftware_database' is set
      if @api_client.config.client_side_validation && vbasoftware_database.nil?
        fail ArgumentError, "Missing the required parameter 'vbasoftware_database' when calling UserApi.update_batch_users"
      end
      # verify the required parameter 'users' is set
      if @api_client.config.client_side_validation && users.nil?
        fail ArgumentError, "Missing the required parameter 'users' when calling UserApi.update_batch_users"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"UserApi.update_batch_users",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: UserApi#update_batch_users\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [UsersVBAResponse]
    def update_user(vbasoftware_database, user_id, users, opts = {})
      data, _status_code, _headers = update_user_with_http_info(vbasoftware_database, user_id, users, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(UsersVBAResponse, Integer, Hash)>] UsersVBAResponse data, response status code and response headers
    def update_user_with_http_info(vbasoftware_database, user_id, users, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: UserApi.update_user ...'
      end
      # verify the required parameter 'vbasoftware_database' is set
      if @api_client.config.client_side_validation && vbasoftware_database.nil?
        fail ArgumentError, "Missing the required parameter 'vbasoftware_database' when calling UserApi.update_user"
      end
      # verify the required parameter 'user_id' is set
      if @api_client.config.client_side_validation && user_id.nil?
      ...
      # verify the required parameter 'users' is set
      if @api_client.config.client_side_validation && users.nil?
        fail ArgumentError, "Missing the required parameter 'users' when calling UserApi.update_user"
      end
      # resource path
      local_var_path = '/users/{userID}'.sub('{' + 'userID' + '}', CGI.escape(user_id.to_s))
    ...
    def user_authentication_with_http_info(vbasoftware_client_id, vbasoftware_client_code, vbasoftware_database, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: UserApi.user_authentication ...'
      end
      # verify the required parameter 'vbasoftware_client_id' is set
      if @api_client.config.client_side_validation && vbasoftware_client_id.nil?
        fail ArgumentError, "Missing the required parameter 'vbasoftware_client_id' when calling UserApi.user_authentication"
      end
      # verify the required parameter 'vbasoftware_client_code' is set
      if @api_client.config.client_side_validation && vbasoftware_client_code.nil?
        fail ArgumentError, "Missing the required parameter 'vbasoftware_client_code' when calling UserApi.user_authentication"
      end
      # verify the required parameter 'vbasoftware_database' is set
      if @api_client.config.client_side_validation && vbasoftware_database.nil?
        fail ArgumentError, "Missing the required parameter 'vbasoftware_database' when calling UserApi.user_authentication"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"UserApi.user_authentication",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: UserApi#user_authentication\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def user_change_password_with_http_info(vbasoftware_database, user_id, user_reset_password_request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: UserApi.user_change_password ...'
      end
      # verify the required parameter 'vbasoftware_database' is set
      if @api_client.config.client_side_validation && vbasoftware_database.nil?
        fail ArgumentError, "Missing the required parameter 'vbasoftware_database' when calling UserApi.user_change_password"
      end
      # verify the required parameter 'user_id' is set
      if @api_client.config.client_side_validation && user_id.nil?
        fail ArgumentError, "Missing the required parameter 'user_id' when calling UserApi.user_change_password"
      end
      ...
      if @api_client.config.client_side_validation && user_reset_password_request.nil?
        fail ArgumentError, "Missing the required parameter 'user_reset_password_request' when calling UserApi.user_change_password"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"UserApi.user_change_password",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: UserApi#user_change_password\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def user_change_temp_password_with_http_info(vbasoftware_client_id, vbasoftware_client_code, vbasoftware_database, user_change_temp_password_request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: UserApi.user_change_temp_password ...'
      end
      # verify the required parameter 'vbasoftware_client_id' is set
      if @api_client.config.client_side_validation && vbasoftware_client_id.nil?
        fail ArgumentError, "Missing the required parameter 'vbasoftware_client_id' when calling UserApi.user_change_temp_password"
      end
      # verify the required parameter 'vbasoftware_client_code' is set
      if @api_client.config.client_side_validation && vbasoftware_client_code.nil?
        fail ArgumentError, "Missing the required parameter 'vbasoftware_client_code' when calling UserApi.user_change_temp_password"
      end
      # verify the required parameter 'vbasoftware_database' is set
      if @api_client.config.client_side_validation && vbasoftware_database.nil?
        fail ArgumentError, "Missing the required parameter 'vbasoftware_database' when calling UserApi.user_change_temp_password"
      end
      ...
      if @api_client.config.client_side_validation && user_change_temp_password_request.nil?
        fail ArgumentError, "Missing the required parameter 'user_change_temp_password_request' when calling UserApi.user_change_temp_password"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"UserApi.user_change_temp_password",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: UserApi#user_change_temp_password\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def user_reset_password_with_http_info(vbasoftware_database, user_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: UserApi.user_reset_password ...'
      end
      # verify the required parameter 'vbasoftware_database' is set
      if @api_client.config.client_side_validation && vbasoftware_database.nil?
        fail ArgumentError, "Missing the required parameter 'vbasoftware_database' when calling UserApi.user_reset_password"
      end
      # verify the required parameter 'user_id' is set
      if @api_client.config.client_side_validation && user_id.nil?
        fail ArgumentError, "Missing the required parameter 'user_id' when calling UserApi.user_reset_password"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"UserApi.user_reset_password",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: UserApi#user_reset_password\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
