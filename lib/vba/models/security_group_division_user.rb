...
module Vba
  class SecurityGroupDivisionUser
    # Key of the SecurityGroupDivisionUser record
    attr_accessor :security_group_division_user_key
    ...
    def self.attribute_map
      {
        :'security_group_division_user_key' => :'securityGroupDivisionUser_Key',
    ...
    def self.openapi_types
      {
        :'security_group_division_user_key' => :'Integer',
        :'division_id' => :'String',
        :'excluded' => :'Boolean',
        :'group_id' => :'String',
        :'user_id' => :'String'
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Vba::SecurityGroupDivisionUser` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Vba::SecurityGroupDivisionUser`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'security_group_division_user_key')
        self.security_group_division_user_key = attributes[:'security_group_division_user_key']
      else
        self.security_group_division_user_key = nil
      end
    ...
    def list_invalid_properties
      ...
      if @security_group_division_user_key.nil?
        invalid_properties.push('invalid value for "security_group_division_user_key", security_group_division_user_key cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @security_group_division_user_key.nil?
    ...
    # @param [Object] security_group_division_user_key Value to be assigned
    def security_group_division_user_key=(security_group_division_user_key)
      if security_group_division_user_key.nil?
        fail ArgumentError, 'security_group_division_user_key cannot be nil'
      end

      @security_group_division_user_key = security_group_division_user_key
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          security_group_division_user_key == o.security_group_division_user_key &&
    ...
    def hash
      [security_group_division_user_key, division_id, excluded, group_id, user_id].hash
    end
