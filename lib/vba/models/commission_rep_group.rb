...
module Vba
  class CommissionRepGroup
    attr_accessor :commission_rep_group_key
    ...
    def self.attribute_map
      {
        :'commission_rep_group_key' => :'commissionRepGroup_Key',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Vba::CommissionRepGroup` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Vba::CommissionRepGroup`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'commission_rep_group_key')
        self.commission_rep_group_key = attributes[:'commission_rep_group_key']
      else
        self.commission_rep_group_key = nil
      end
    ...
    def list_invalid_properties
      ...
      if @commission_rep_group_key.nil?
        invalid_properties.push('invalid value for "commission_rep_group_key", commission_rep_group_key cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @commission_rep_group_key.nil?
    ...
    # @param [Object] commission_rep_group_key Value to be assigned
    def commission_rep_group_key=(commission_rep_group_key)
      if commission_rep_group_key.nil?
        fail ArgumentError, 'commission_rep_group_key cannot be nil'
      end

      @commission_rep_group_key = commission_rep_group_key
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          commission_rep_group_key == o.commission_rep_group_key &&
    ...
    def hash
      [commission_rep_group_key, commission_rep_key, division_id, entry_date, entry_user, group_id, update_date, update_user].hash
    end
