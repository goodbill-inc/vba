...
module Vba
  class ProviderCredMalpractice
    ...
    attr_accessor :occurrence_amount

    # Specific limit of the malpractice policy.
    attr_accessor :specific_limit
    ...
    def self.openapi_types
      {
        ...
        :'entry_date' => :'Time',
        :'entry_user' => :'String',
        :'occurrence_amount' => :'Float',
        :'specific_limit' => :'Float',
        :'term_date' => :'Time',
        :'update_date' => :'Time',
        :'update_user' => :'String'
      }
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Vba::ProviderCredMalpractice` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Vba::ProviderCredMalpractice`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'aggregate_limit')
        self.aggregate_limit = attributes[:'aggregate_limit']
      end
      ...
      if attributes.key?(:'occurrence_amount')
        self.occurrence_amount = attributes[:'occurrence_amount']
      end

      if attributes.key?(:'specific_limit')
        self.specific_limit = attributes[:'specific_limit']
      end
    ...
    def list_invalid_properties
      ...
      if @policy_number.to_s.length > 32
    ...
    def valid?
      ...
      return false if @policy_number.to_s.length > 32
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          aggregate_limit == o.aggregate_limit &&
          effective_date == o.effective_date &&
          entry_date == o.entry_date &&
          entry_user == o.entry_user &&
          occurrence_amount == o.occurrence_amount &&
          specific_limit == o.specific_limit &&
    ...
    def hash
      [provider_cred_key, cred_carrier_key, policy_number, aggregate_limit, effective_date, entry_date, entry_user, occurrence_amount, specific_limit, term_date, update_date, update_user].hash
    end
