...
module Vba
  class SecurityFieldUser
    ...
    attr_accessor :security_field_user_key
    ...
    def self.attribute_map
      {
        :'security_field_user_key' => :'securityFieldUser_Key',
    ...
    def self.openapi_types
      {
        :'security_field_user_key' => :'Integer',
        :'entry_date' => :'Time',
        :'entry_user' => :'String',
        :'field_access' => :'String',
        :'field_mask' => :'String',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Vba::SecurityFieldUser` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Vba::SecurityFieldUser`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'security_field_user_key')
        self.security_field_user_key = attributes[:'security_field_user_key']
      else
        self.security_field_user_key = nil
      end
    ...
    def list_invalid_properties
      ...
      if @security_field_user_key.nil?
        invalid_properties.push('invalid value for "security_field_user_key", security_field_user_key cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @security_field_user_key.nil?
    ...
    # @param [Object] security_field_user_key Value to be assigned
    def security_field_user_key=(security_field_user_key)
      if security_field_user_key.nil?
        fail ArgumentError, 'security_field_user_key cannot be nil'
      end

      @security_field_user_key = security_field_user_key
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          security_field_user_key == o.security_field_user_key &&
    ...
    def hash
      [security_field_user_key, entry_date, entry_user, field_access, field_mask, security_field_set_id, security_field_id, update_date, update_user, user_id].hash
    end
