...
module Vba
  class SubscriberForfeitureStatus
    ...
    attr_accessor :forfeiture_status
    ...
    def self.attribute_map
      {
        ...
        :'forfeiture_status' => :'forfeiture_Status',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Vba::SubscriberForfeitureStatus` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Vba::SubscriberForfeitureStatus`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'policy_number')
        ...
        self.policy_number = nil
      end

      if attributes.key?(:'forfeiture_status')
        self.forfeiture_status = attributes[:'forfeiture_status']
      else
        self.forfeiture_status = nil
      end
    ...
    def list_invalid_properties
      ...
      if @policy_number.nil?
        invalid_properties.push('invalid value for "policy_number", policy_number cannot be nil.')
      end

      if @policy_number.to_s.length > 64
        invalid_properties.push('invalid value for "policy_number", the character length must be smaller than or equal to 64.')
      end

      if @policy_number.to_s.length < 1
        invalid_properties.push('invalid value for "policy_number", the character length must be great than or equal to 1.')
      end

      if @forfeiture_status.nil?
        invalid_properties.push('invalid value for "forfeiture_status", forfeiture_status cannot be nil.')
      end

      if @forfeiture_status.to_s.length > 32
        invalid_properties.push('invalid value for "forfeiture_status", the character length must be smaller than or equal to 32.')
      end

      if @forfeiture_status.to_s.length < 1
        invalid_properties.push('invalid value for "forfeiture_status", the character length must be great than or equal to 1.')
      end
    ...
    def valid?
      ...
      return false if @policy_number.nil?
      return false if @policy_number.to_s.length > 64
      return false if @policy_number.to_s.length < 1
      return false if @forfeiture_status.nil?
      return false if @forfeiture_status.to_s.length > 32
      return false if @forfeiture_status.to_s.length < 1
    ...
    def policy_number=(policy_number)
      if policy_number.nil?
        fail ArgumentError, 'policy_number cannot be nil'
      end
      ...
      if policy_number.to_s.length < 1
        fail ArgumentError, 'invalid value for "policy_number", the character length must be great than or equal to 1.'
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] forfeiture_status Value to be assigned
    def forfeiture_status=(forfeiture_status)
      if forfeiture_status.nil?
        fail ArgumentError, 'forfeiture_status cannot be nil'
      end

      if forfeiture_status.to_s.length > 32
        fail ArgumentError, 'invalid value for "forfeiture_status", the character length must be smaller than or equal to 32.'
      end

      if forfeiture_status.to_s.length < 1
        fail ArgumentError, 'invalid value for "forfeiture_status", the character length must be great than or equal to 1.'
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          forfeiture_status == o.forfeiture_status &&
    ...
    def hash
      [subscriber_id, plan_id, benefit_code, policy_number, forfeiture_status, effective_date, entry_date, entry_user, term_date, update_date, update_user].hash
    end
