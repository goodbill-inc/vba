...
module Vba
  class PremPaymentOnAccount
    attr_accessor :prem_payment_on_account_key
    ...
    def self.attribute_map
      {
        :'prem_payment_on_account_key' => :'premPaymentOnAccount_Key',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Vba::PremPaymentOnAccount` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Vba::PremPaymentOnAccount`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'prem_payment_on_account_key')
        self.prem_payment_on_account_key = attributes[:'prem_payment_on_account_key']
      else
        self.prem_payment_on_account_key = nil
      end
    ...
    def list_invalid_properties
      ...
      if @prem_payment_on_account_key.nil?
        invalid_properties.push('invalid value for "prem_payment_on_account_key", prem_payment_on_account_key cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @prem_payment_on_account_key.nil?
    ...
    # @param [Object] prem_payment_on_account_key Value to be assigned
    def prem_payment_on_account_key=(prem_payment_on_account_key)
      if prem_payment_on_account_key.nil?
        fail ArgumentError, 'prem_payment_on_account_key cannot be nil'
      end

      @prem_payment_on_account_key = prem_payment_on_account_key
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          prem_payment_on_account_key == o.prem_payment_on_account_key &&
    ...
    def hash
      [prem_payment_on_account_key, entry_date, entry_user, group_id, payment_amount, payment_posted, payor_id, plan_type, prem_payment_key, subscriber_id, update_date, update_user].hash
    end
