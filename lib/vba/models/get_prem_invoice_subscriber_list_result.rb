...
module Vba
  class GetPremInvoiceSubscriberListResult
    ...
    attr_accessor :premium_waived_calc
    ...
    def self.attribute_map
      {
        ...
        :'premium_waived_calc' => :'premium_Waived_Calc'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Vba::GetPremInvoiceSubscriberListResult` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Vba::GetPremInvoiceSubscriberListResult`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'premium_waived_calc')
        self.premium_waived_calc = attributes[:'premium_waived_calc']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          premium_waived_calc == o.premium_waived_calc
    end
    ...
    def hash
      [invoice_key, group_id, division_id, subscriber_id, subscriber_name, premium, adjustment, received, due, premium_waived, dependent_count, member_count, premium_waived_calc].hash
    end
