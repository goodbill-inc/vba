...
module Vba
  class MemberPriorAccum
    ...
    attr_accessor :not_covered_amt_oon
    ...
    def self.attribute_map
      {
        ...
        :'not_covered_amt_oon' => :'not_Covered_Amt_OON',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Vba::MemberPriorAccum` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Vba::MemberPriorAccum`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'not_covered_amt_oon')
        self.not_covered_amt_oon = attributes[:'not_covered_amt_oon']
      else
        self.not_covered_amt_oon = nil
      end
    ...
    def list_invalid_properties
      ...
      if @auto_generated.nil?
        invalid_properties.push('invalid value for "auto_generated", auto_generated cannot be nil.')
      end
      ...
      if @not_covered_amt_oon.nil?
        invalid_properties.push('invalid value for "not_covered_amt_oon", not_covered_amt_oon cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @auto_generated.nil?
      ...
      return false if @not_covered_amt_oon.nil?
    ...
    # Custom attribute writer method with validation
    # @param [Object] auto_generated Value to be assigned
    def auto_generated=(auto_generated)
      if auto_generated.nil?
        fail ArgumentError, 'auto_generated cannot be nil'
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] not_covered_amt_oon Value to be assigned
    def not_covered_amt_oon=(not_covered_amt_oon)
      if not_covered_amt_oon.nil?
        fail ArgumentError, 'not_covered_amt_oon cannot be nil'
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          not_covered_amt_oon == o.not_covered_amt_oon &&
    ...
    def hash
      [subscriber_id, member_seq, group_id, division_id, plan_year, plan_type, benefit_code, added_accum, allowed_amt, allowed_amt_net, allowed_amt_oon, auto_generated, benefit_used, benefit_used_net, benefit_used_oon, billed_amt, billed_amt_net, billed_amt_oon, co_b_amt, co_b_amt_net, co_b_amt_oon, coins_amt, coins_amt_net, coins_amt_oon, copay_amt, copay_amt_net, copay_amt_oon, currency_id, ded_ppo_used, deductible_used, deductible_used_oon, entry_date, entry_user, not_covered_amt, not_covered_amt_net, not_covered_amt_oon, out_of_pocket, out_of_pocket_net, out_of_pocket_oon, update_date, update_user].hash
    end
