...
module Vba
  class DRGCodes
    ...
    # Flag that specifies if the DRG is related to cervical or lumbar
    attr_accessor :cervical_or_lumbar
    ...
    def self.attribute_map
      {
        :'dr_g_code' => :'drG_Code',
        :'cervical_or_lumbar' => :'cervicalOrLumbar',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Vba::DRGCodes` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Vba::DRGCodes`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'cervical_or_lumbar')
        self.cervical_or_lumbar = attributes[:'cervical_or_lumbar']
      end
    ...
    def list_invalid_properties
      ...
      if !@cervical_or_lumbar.nil? && @cervical_or_lumbar.to_s.length > 1
        invalid_properties.push('invalid value for "cervical_or_lumbar", the character length must be smaller than or equal to 1.')
      end
    ...
    def valid?
      ...
      return false if !@cervical_or_lumbar.nil? && @cervical_or_lumbar.to_s.length > 1
    ...
    # Custom attribute writer method with validation
    # @param [Object] cervical_or_lumbar Value to be assigned
    def cervical_or_lumbar=(cervical_or_lumbar)
      if !cervical_or_lumbar.nil? && cervical_or_lumbar.to_s.length > 1
        fail ArgumentError, 'invalid value for "cervical_or_lumbar", the character length must be smaller than or equal to 1.'
      end

      @cervical_or_lumbar = cervical_or_lumbar
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          cervical_or_lumbar == o.cervical_or_lumbar &&
    ...
    def hash
      [dr_g_code, cervical_or_lumbar, description, entry_date, entry_user, update_date, update_user].hash
    end
