...
module Vba
  class GroupDivisionCobra
    ...
    # Which Division ID inside this Group that is the COBRA Division.
    attr_accessor :cobra_division_id
    ...
    def self.attribute_map
      {
        ...
        :'cobra_division_id' => :'cobra_Division_ID'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Vba::GroupDivisionCobra` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Vba::GroupDivisionCobra`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'cobra_division_id')
        self.cobra_division_id = attributes[:'cobra_division_id']
      else
        self.cobra_division_id = nil
      end
    end
    ...
    def list_invalid_properties
      ...
      if @cobra_division_id.nil?
        invalid_properties.push('invalid value for "cobra_division_id", cobra_division_id cannot be nil.')
      end

      if @cobra_division_id.to_s.length > 20
        invalid_properties.push('invalid value for "cobra_division_id", the character length must be smaller than or equal to 20.')
      end

      if @cobra_division_id.to_s.length < 1
        invalid_properties.push('invalid value for "cobra_division_id", the character length must be great than or equal to 1.')
      end
    ...
    def valid?
      ...
      return false if @cobra_division_id.nil?
      return false if @cobra_division_id.to_s.length > 20
      return false if @cobra_division_id.to_s.length < 1
      true
    end
    ...
    # Custom attribute writer method with validation
    # @param [Object] cobra_division_id Value to be assigned
    def cobra_division_id=(cobra_division_id)
      if cobra_division_id.nil?
        fail ArgumentError, 'cobra_division_id cannot be nil'
      end

      if cobra_division_id.to_s.length > 20
        fail ArgumentError, 'invalid value for "cobra_division_id", the character length must be smaller than or equal to 20.'
      end

      if cobra_division_id.to_s.length < 1
        fail ArgumentError, 'invalid value for "cobra_division_id", the character length must be great than or equal to 1.'
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          cobra_division_id == o.cobra_division_id
    end
    ...
    def hash
      [group_id, division_id, cobra_division_id].hash
    end
