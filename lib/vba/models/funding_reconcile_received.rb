...
module Vba
  class FundingReconcileReceived
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Vba::FundingReconcileReceived` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Vba::FundingReconcileReceived`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def list_invalid_properties
      ...
      if @deposit_key.nil?
        invalid_properties.push('invalid value for "deposit_key", deposit_key cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @deposit_key.nil?
    ...
    # Custom attribute writer method with validation
    # @param [Object] deposit_key Value to be assigned
    def deposit_key=(deposit_key)
      if deposit_key.nil?
        fail ArgumentError, 'deposit_key cannot be nil'
      end
    ...
    def hash
      [reconcile_key, deposit_key, entry_date, entry_user, selected, update_date, update_user].hash
    end
