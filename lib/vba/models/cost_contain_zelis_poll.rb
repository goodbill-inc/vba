...
module Vba
  class CostContainZelisPoll
    attr_accessor :cost_contain_zelis_poll_key
    ...
    attr_accessor :poll_date

    attr_accessor :status

    attr_accessor :transaction_id

    attr_accessor :zelis_result

    # Attribute mapping from ruby-style variable name to JSON key.
    def self.attribute_map
      {
        :'cost_contain_zelis_poll_key' => :'costContainZelisPoll_Key',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Vba::CostContainZelisPoll` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Vba::CostContainZelisPoll`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'cost_contain_zelis_poll_key')
        self.cost_contain_zelis_poll_key = attributes[:'cost_contain_zelis_poll_key']
      else
        self.cost_contain_zelis_poll_key = nil
      end
      ...
      if attributes.key?(:'poll_date')
        self.poll_date = attributes[:'poll_date']
      end
      ...
      if attributes.key?(:'zelis_result')
        self.zelis_result = attributes[:'zelis_result']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @cost_contain_zelis_poll_key.nil?
        invalid_properties.push('invalid value for "cost_contain_zelis_poll_key", cost_contain_zelis_poll_key cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @cost_contain_zelis_poll_key.nil?
    ...
    # @param [Object] cost_contain_zelis_poll_key Value to be assigned
    def cost_contain_zelis_poll_key=(cost_contain_zelis_poll_key)
      if cost_contain_zelis_poll_key.nil?
        fail ArgumentError, 'cost_contain_zelis_poll_key cannot be nil'
      end

      @cost_contain_zelis_poll_key = cost_contain_zelis_poll_key
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          cost_contain_zelis_poll_key == o.cost_contain_zelis_poll_key &&
          ...
          poll_date == o.poll_date &&
          status == o.status &&
          transaction_id == o.transaction_id &&
          zelis_result == o.zelis_result
    end
    ...
    def hash
      [cost_contain_zelis_poll_key, batch_claim, batch_number, claim_queue_processor_key, error_description, poll_date, status, transaction_id, zelis_result].hash
    end
