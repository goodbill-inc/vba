  ...
  class ReinsLevel
    ...
    def self.attribute_map
      {
        ...
        :'reins_level_seq' => :'reinsLevel_Seq',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Vba::ReinsLevel` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Vba::ReinsLevel`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'reins_level_seq')
        self.reins_level_seq = attributes[:'reins_level_seq']
      else
        self.reins_level_seq = nil
      end
    ...
    def list_invalid_properties
      ...
      if @reins_level_seq.nil?
        invalid_properties.push('invalid value for "reins_level_seq", reins_level_seq cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @reins_level_seq.nil?
    ...
    # Custom attribute writer method with validation
    # @param [Object] reins_level_seq Value to be assigned
    def reins_level_seq=(reins_level_seq)
      if reins_level_seq.nil?
        fail ArgumentError, 'reins_level_seq cannot be nil'
      end

      @reins_level_seq = reins_level_seq
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          reins_level_seq == o.reins_level_seq &&
    ...
    def hash
      [reins_contract_key, reins_level_seq, benefit_code, deductible_pct, entry_date, entry_user, reins_level_from, reins_level_thru, update_date, update_user].hash
    end
