  ...
  class SubEnrollmentRider
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Vba::SubEnrollmentRider` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Vba::SubEnrollmentRider`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def list_invalid_properties
      ...
      if !@billing_member_seq_override.nil? && @billing_member_seq_override.to_s.length > 2
        invalid_properties.push('invalid value for "billing_member_seq_override", the character length must be smaller than or equal to 2.')
      end
      ...
      if @use_employee_age.nil?
        invalid_properties.push('invalid value for "use_employee_age", use_employee_age cannot be nil.')
      end

      if @use_gi_volume_min_max.nil?
        invalid_properties.push('invalid value for "use_gi_volume_min_max", use_gi_volume_min_max cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if !@billing_member_seq_override.nil? && @billing_member_seq_override.to_s.length > 2
      ...
      return false if @use_employee_age.nil?
      return false if @use_gi_volume_min_max.nil?
    ...
    # Custom attribute writer method with validation
    # @param [Object] billing_member_seq_override Value to be assigned
    def billing_member_seq_override=(billing_member_seq_override)
      if !billing_member_seq_override.nil? && billing_member_seq_override.to_s.length > 2
        fail ArgumentError, 'invalid value for "billing_member_seq_override", the character length must be smaller than or equal to 2.'
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] use_employee_age Value to be assigned
    def use_employee_age=(use_employee_age)
      if use_employee_age.nil?
        fail ArgumentError, 'use_employee_age cannot be nil'
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] use_gi_volume_min_max Value to be assigned
    def use_gi_volume_min_max=(use_gi_volume_min_max)
      if use_gi_volume_min_max.nil?
        fail ArgumentError, 'use_gi_volume_min_max cannot be nil'
      end
    ...
    def hash
      [subscriber_id, group_id, division_id, group_coverage_start, start_date, plan_id, plan_start, benefit_code, from_date, billing_member_seq_override, employee_contribution, employee_contribution_pct, entry_date, entry_user, external_id, initial_volume, initial_volume_salary_pct, lt_c_daily_benefit_amount, lt_c_lifetime_max_amount, lt_c_lifetime_max_days, lt_c_lifetime_max_years, lt_c_monthly_benefit_amount, new_commission_agency_rep_key, original_commission_agency_rep_key, thru_date, update_date, update_user, use_employee_age, use_gi_volume_min_max, use_volume_scale, volume].hash
    end
