...
module Vba
  class PremInvoiceGenerateInvList
    ...
    attr_accessor :enrollment_count

    attr_accessor :adjustment_count
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Vba::PremInvoiceGenerateInvList` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Vba::PremInvoiceGenerateInvList`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'enrollment_count')
        self.enrollment_count = attributes[:'enrollment_count']
      end

      if attributes.key?(:'adjustment_count')
        self.adjustment_count = attributes[:'adjustment_count']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          adjustment_count == o.adjustment_count &&
    ...
    def hash
      [selected, invoice_level_sort, invoice_level_id, invoice_level, group_id, group_name, division_id, division_name, group_division_captive, bill_cycle, last_bill_thru, invoice_date, bill_from, bill_thru, inv_date_bill_from, inv_date_bill_thru, bill_date_option, enrollment_count, adjustment_count, invoice_key].hash
    end
