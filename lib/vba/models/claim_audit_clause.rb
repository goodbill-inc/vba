...
module Vba
  class ClaimAuditClause
    attr_accessor :claim_audit_clause_key
    ...
    def self.attribute_map
      {
        :'claim_audit_clause_key' => :'claimAuditClause_Key',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Vba::ClaimAuditClause` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Vba::ClaimAuditClause`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'claim_audit_clause_key')
        self.claim_audit_clause_key = attributes[:'claim_audit_clause_key']
      else
        self.claim_audit_clause_key = nil
      end
    ...
    def list_invalid_properties
      ...
      if @claim_audit_clause_key.nil?
        invalid_properties.push('invalid value for "claim_audit_clause_key", claim_audit_clause_key cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @claim_audit_clause_key.nil?
    ...
    # @param [Object] claim_audit_clause_key Value to be assigned
    def claim_audit_clause_key=(claim_audit_clause_key)
      if claim_audit_clause_key.nil?
        fail ArgumentError, 'claim_audit_clause_key cannot be nil'
      end

      @claim_audit_clause_key = claim_audit_clause_key
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          claim_audit_clause_key == o.claim_audit_clause_key &&
    ...
    def hash
      [claim_audit_clause_key, audit_clause, audit_count, audit_percent, description, entry_date, entry_user, update_date, update_user].hash
    end
