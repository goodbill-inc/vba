  ...
  class PlanModifier
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Vba::PlanModifier` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Vba::PlanModifier`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'apply_uc')
        self.apply_uc = attributes[:'apply_uc']
      else
        self.apply_uc = nil
      end
    ...
    def list_invalid_properties
      ...
      if @apply_uc.nil?
        invalid_properties.push('invalid value for "apply_uc", apply_uc cannot be nil.')
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] apply_uc Value to be assigned
    def apply_uc=(apply_uc)
      if apply_uc.nil?
        fail ArgumentError, 'apply_uc cannot be nil'
      end
    ...
    def hash
      [plan_id, modifier, effective_date, apply_oon, apply_uc, entry_date, entry_user, fee_percent, term_date, update_date, update_user].hash
    end
