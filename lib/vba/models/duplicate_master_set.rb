  ...
  class DuplicateMasterSet
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Vba::DuplicateMasterSet` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Vba::DuplicateMasterSet`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def list_invalid_properties
      ...
      if @duplicate_master_key.nil?
        invalid_properties.push('invalid value for "duplicate_master_key", duplicate_master_key cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @duplicate_master_key.nil?
    ...
    # @param [Object] duplicate_master_key Value to be assigned
    def duplicate_master_key=(duplicate_master_key)
      if duplicate_master_key.nil?
        fail ArgumentError, 'duplicate_master_key cannot be nil'
      end

      @duplicate_master_key = duplicate_master_key
    end
    ...
    def hash
      [duplicate_master_key, duplicate_set_key, entry_date, entry_user, update_date, update_user].hash
    end
