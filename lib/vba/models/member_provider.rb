...
module Vba
  class MemberProvider
    ...
    attr_accessor :member_provider_key
    ...
    def self.attribute_map
      {
        :'member_provider_key' => :'memberProvider_Key',
        :'capitation_category' => :'capitation_Category',
        :'effective_date' => :'effective_Date',
        :'end_date' => :'end_Date',
        :'entry_date' => :'entry_Date',
        :'entry_user' => :'entry_User',
        :'ip_a_number' => :'ipA_Number',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Vba::MemberProvider` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Vba::MemberProvider`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'member_provider_key')
        self.member_provider_key = attributes[:'member_provider_key']
      else
        self.member_provider_key = nil
      end
      ...
      if attributes.key?(:'ip_a_number')
        self.ip_a_number = attributes[:'ip_a_number']
      end
    ...
    def list_invalid_properties
      ...
      if @member_provider_key.nil?
        invalid_properties.push('invalid value for "member_provider_key", member_provider_key cannot be nil.')
      end
      ...
      if !@ip_a_number.nil? && @ip_a_number.to_s.length > 16
        invalid_properties.push('invalid value for "ip_a_number", the character length must be smaller than or equal to 16.')
      end
    ...
    # @param [Object] member_provider_key Value to be assigned
    def member_provider_key=(member_provider_key)
      if member_provider_key.nil?
        fail ArgumentError, 'member_provider_key cannot be nil'
      end

      @member_provider_key = member_provider_key
    end
    ...
    # Custom attribute writer method with validation
    # @param [Object] ip_a_number Value to be assigned
    def ip_a_number=(ip_a_number)
      if !ip_a_number.nil? && ip_a_number.to_s.length > 16
        fail ArgumentError, 'invalid value for "ip_a_number", the character length must be smaller than or equal to 16.'
      end

      @ip_a_number = ip_a_number
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          member_provider_key == o.member_provider_key &&
          capitation_category == o.capitation_category &&
          effective_date == o.effective_date &&
          end_date == o.end_date &&
          entry_date == o.entry_date &&
          entry_user == o.entry_user &&
          ip_a_number == o.ip_a_number &&
    ...
    def hash
      [member_provider_key, capitation_category, effective_date, end_date, entry_date, entry_user, ip_a_number, member_seq, provider_id, reason_code, subscriber_id, update_date, update_user].hash
    end
