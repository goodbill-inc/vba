  ...
  class VBAAppInfo
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Vba::VBAAppInfo` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Vba::VBAAppInfo`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'release_message')
        self.release_message = attributes[:'release_message']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          release_message == o.release_message
    end
    ...
    def hash
      [version, files, path, sha512, release_notes, release_date, release_message].hash
    end
