...
module Vba
  class FeeSchedModifierDiscount
    ...
    attr_accessor :fee_sched_modifier_discount_key
    ...
    def self.attribute_map
      {
        :'fee_sched_modifier_discount_key' => :'feeSchedModifierDiscount_Key',
    ...
    def self.openapi_types
      {
        :'fee_sched_modifier_discount_key' => :'Integer',
        :'discount_pct' => :'Float',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Vba::FeeSchedModifierDiscount` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Vba::FeeSchedModifierDiscount`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'fee_sched_modifier_discount_key')
        self.fee_sched_modifier_discount_key = attributes[:'fee_sched_modifier_discount_key']
      else
        self.fee_sched_modifier_discount_key = nil
      end
    ...
    def list_invalid_properties
      ...
      if @fee_sched_modifier_discount_key.nil?
        invalid_properties.push('invalid value for "fee_sched_modifier_discount_key", fee_sched_modifier_discount_key cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @fee_sched_modifier_discount_key.nil?
    ...
    # @param [Object] fee_sched_modifier_discount_key Value to be assigned
    def fee_sched_modifier_discount_key=(fee_sched_modifier_discount_key)
      if fee_sched_modifier_discount_key.nil?
        fail ArgumentError, 'fee_sched_modifier_discount_key cannot be nil'
      end

      @fee_sched_modifier_discount_key = fee_sched_modifier_discount_key
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          fee_sched_modifier_discount_key == o.fee_sched_modifier_discount_key &&
    ...
    def hash
      [fee_sched_modifier_discount_key, discount_pct, discount_seq, effective_date, entry_date, entry_user, fee_sched, modifier1, modifier2, modifier3, modifier4, update_date, update_user].hash
    end
