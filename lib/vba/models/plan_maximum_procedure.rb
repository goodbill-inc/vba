  ...
  class PlanMaximumProcedure
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Vba::PlanMaximumProcedure` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Vba::PlanMaximumProcedure`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def list_invalid_properties
      ...
      if @thru_procedure.nil?
        invalid_properties.push('invalid value for "thru_procedure", thru_procedure cannot be nil.')
      end

      if @thru_procedure.to_s.length > 8
        invalid_properties.push('invalid value for "thru_procedure", the character length must be smaller than or equal to 8.')
      end

      if @thru_procedure.to_s.length < 1
        invalid_properties.push('invalid value for "thru_procedure", the character length must be great than or equal to 1.')
      end
    ...
    def valid?
      ...
      return false if @thru_procedure.nil?
      return false if @thru_procedure.to_s.length > 8
      return false if @thru_procedure.to_s.length < 1
    ...
    def thru_procedure=(thru_procedure)
      if thru_procedure.nil?
        fail ArgumentError, 'thru_procedure cannot be nil'
      end
      ...
      if thru_procedure.to_s.length < 1
        fail ArgumentError, 'invalid value for "thru_procedure", the character length must be great than or equal to 1.'
      end
    ...
    def hash
      [plan_id, benefit_code, max_id, from_procedure, entry_date, entry_user, procedure_code1, procedure_code2, thru_procedure, update_date, update_user].hash
    end
