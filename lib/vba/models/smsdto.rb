...
module Vba
  class SMSDTO
    ...
    attr_accessor :sender_client_id
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Vba::SMSDTO` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Vba::SMSDTO`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'sender_client_id')
        self.sender_client_id = attributes[:'sender_client_id']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          sender_client_id == o.sender_client_id &&
    ...
    def hash
      [parent_activity_id, _when, on_success, on_failure, sender_client_id, to_number, content].hash
    end
