...
module Vba
  class DisabilityEventCaseChanged
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Vba::DisabilityEventCaseChanged` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Vba::DisabilityEventCaseChanged`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'disability_event_case_changed_key')
        ...
        self.disability_event_case_changed_key = nil
      end
    ...
    def list_invalid_properties
      ...
      if @disability_event_case_changed_key.nil?
        invalid_properties.push('invalid value for "disability_event_case_changed_key", disability_event_case_changed_key cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @disability_event_case_changed_key.nil?
    ...
    # @param [Object] disability_event_case_changed_key Value to be assigned
    def disability_event_case_changed_key=(disability_event_case_changed_key)
      if disability_event_case_changed_key.nil?
        fail ArgumentError, 'disability_event_case_changed_key cannot be nil'
      end

      @disability_event_case_changed_key = disability_event_case_changed_key
    end
    ...
    def hash
      [disability_event_case_changed_key, case_status, case_status_reason, disability_type, entry_date, entry_user, ex_code, update_date, update_user].hash
    end
