...
module Vba
  class ReportTrackPriority
    ...
    attr_accessor :priority_default
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Vba::ReportTrackPriority` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Vba::ReportTrackPriority`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'priority_default')
        self.priority_default = attributes[:'priority_default']
      else
        self.priority_default = nil
      end
    ...
    def list_invalid_properties
      ...
      if @priority_default.nil?
        invalid_properties.push('invalid value for "priority_default", priority_default cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @priority.to_s.length > 32
      return false if @priority.to_s.length < 1
      return false if !@description.nil? && @description.to_s.length > 128
      return false if !@entry_user.nil? && @entry_user.to_s.length > 20
      return false if @priority_default.nil?
    ...
    # Custom attribute writer method with validation
    # @param [Object] priority_default Value to be assigned
    def priority_default=(priority_default)
      if priority_default.nil?
        fail ArgumentError, 'priority_default cannot be nil'
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          priority_default == o.priority_default &&
    ...
    def hash
      [report_definition_key, priority, description, entry_date, entry_user, priority_default, update_date, update_user].hash
    end
