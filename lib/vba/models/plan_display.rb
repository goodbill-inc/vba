...
module Vba
  class PlanDisplay
    ...
    attr_accessor :plan_display_key
    ...
    def self.attribute_map
      {
        :'plan_display_key' => :'planDisplay_Key',
        :'display' => :'display',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Vba::PlanDisplay` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Vba::PlanDisplay`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'plan_display_key')
        self.plan_display_key = attributes[:'plan_display_key']
      else
        self.plan_display_key = nil
      end
    ...
    def list_invalid_properties
      ...
      if @plan_display_key.nil?
        invalid_properties.push('invalid value for "plan_display_key", plan_display_key cannot be nil.')
      end

      if !@display.nil? && @display.to_s.length > 512
        invalid_properties.push('invalid value for "display", the character length must be smaller than or equal to 512.')
      end
      ...
      if @display_type.to_s.length > 32
        invalid_properties.push('invalid value for "display_type", the character length must be smaller than or equal to 32.')
      end
    ...
    def valid?
      ...
      return false if @plan_display_key.nil?
      return false if !@display.nil? && @display.to_s.length > 512
      return false if @display_type.nil?
      return false if @display_type.to_s.length > 32
    ...
    # @param [Object] plan_display_key Value to be assigned
    def plan_display_key=(plan_display_key)
      if plan_display_key.nil?
        fail ArgumentError, 'plan_display_key cannot be nil'
      end

      @plan_display_key = plan_display_key
    end
    ...
    def display=(display)
      if !display.nil? && display.to_s.length > 512
        fail ArgumentError, 'invalid value for "display", the character length must be smaller than or equal to 512.'
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] display_type Value to be assigned
    def display_type=(display_type)
      if display_type.nil?
        fail ArgumentError, 'display_type cannot be nil'
      end

      if display_type.to_s.length > 32
        fail ArgumentError, 'invalid value for "display_type", the character length must be smaller than or equal to 32.'
      end

      if display_type.to_s.length < 1
        fail ArgumentError, 'invalid value for "display_type", the character length must be great than or equal to 1.'
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          plan_display_key == o.plan_display_key &&
          display == o.display &&
    ...
    def hash
      [plan_display_key, display, display_type, entry_date, entry_user, plan_id, update_date, update_user].hash
    end
