...
module Vba
  class FundingAccountSignature
    ...
    attr_accessor :funding_account_signature_key
    ...
    def self.attribute_map
      {
        :'funding_account_signature_key' => :'fundingAccountSignature_Key',
    ...
    def self.openapi_types
      {
        :'funding_account_signature_key' => :'Integer',
        :'account_key' => :'Integer',
        :'effective_date' => :'Time',
        :'entry_date' => :'Time',
        :'entry_user' => :'String',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Vba::FundingAccountSignature` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Vba::FundingAccountSignature`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'funding_account_signature_key')
        self.funding_account_signature_key = attributes[:'funding_account_signature_key']
      else
        self.funding_account_signature_key = nil
      end
    ...
    def list_invalid_properties
      ...
      if @funding_account_signature_key.nil?
        invalid_properties.push('invalid value for "funding_account_signature_key", funding_account_signature_key cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @funding_account_signature_key.nil?
    ...
    # @param [Object] funding_account_signature_key Value to be assigned
    def funding_account_signature_key=(funding_account_signature_key)
      if funding_account_signature_key.nil?
        fail ArgumentError, 'funding_account_signature_key cannot be nil'
      end

      @funding_account_signature_key = funding_account_signature_key
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          funding_account_signature_key == o.funding_account_signature_key &&
    ...
    def hash
      [funding_account_signature_key, account_key, effective_date, entry_date, entry_user, signature_key, term_date, update_date, update_user].hash
    end
