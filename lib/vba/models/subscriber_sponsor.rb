...
module Vba
  class SubscriberSponsor
    ...
    attr_accessor :subscriber_sponsor_key
    ...
    def self.attribute_map
      {
        :'subscriber_sponsor_key' => :'subscriberSponsor_Key',
    ...
    def self.openapi_types
      {
        :'subscriber_sponsor_key' => :'Integer',
        :'effective_date' => :'Time',
        :'entry_date' => :'Time',
        :'entry_user' => :'String',
        :'sponsor_id' => :'String',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Vba::SubscriberSponsor` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Vba::SubscriberSponsor`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'subscriber_sponsor_key')
        self.subscriber_sponsor_key = attributes[:'subscriber_sponsor_key']
      else
        self.subscriber_sponsor_key = nil
      end
    ...
    def list_invalid_properties
      ...
      if @subscriber_sponsor_key.nil?
        invalid_properties.push('invalid value for "subscriber_sponsor_key", subscriber_sponsor_key cannot be nil.')
      end
      ...
      if @sponsor_id.nil?
        invalid_properties.push('invalid value for "sponsor_id", sponsor_id cannot be nil.')
      end

      if @sponsor_id.to_s.length > 9
        invalid_properties.push('invalid value for "sponsor_id", the character length must be smaller than or equal to 9.')
      end

      if @sponsor_id.to_s.length < 1
        invalid_properties.push('invalid value for "sponsor_id", the character length must be great than or equal to 1.')
      end
    ...
    def valid?
      ...
      return false if @subscriber_sponsor_key.nil?
      return false if !@entry_user.nil? && @entry_user.to_s.length > 20
      return false if @sponsor_id.nil?
      return false if @sponsor_id.to_s.length > 9
      return false if @sponsor_id.to_s.length < 1
    ...
    # @param [Object] subscriber_sponsor_key Value to be assigned
    def subscriber_sponsor_key=(subscriber_sponsor_key)
      if subscriber_sponsor_key.nil?
        fail ArgumentError, 'subscriber_sponsor_key cannot be nil'
      end

      @subscriber_sponsor_key = subscriber_sponsor_key
    end
    ...
    def sponsor_id=(sponsor_id)
      if sponsor_id.nil?
        fail ArgumentError, 'sponsor_id cannot be nil'
      end
      ...
      if sponsor_id.to_s.length < 1
        fail ArgumentError, 'invalid value for "sponsor_id", the character length must be great than or equal to 1.'
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          subscriber_sponsor_key == o.subscriber_sponsor_key &&
    ...
    def hash
      [subscriber_sponsor_key, effective_date, entry_date, entry_user, sponsor_id, sponsor_relate_code, subscriber_id, term_date, update_date, update_user].hash
    end
