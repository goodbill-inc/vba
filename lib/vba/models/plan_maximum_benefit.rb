...
module Vba
  class PlanMaximumBenefit
    ...
    # Additional Benefit Code included in the Maximum.
    attr_accessor :included_benefit_code
    ...
    def self.attribute_map
      {
        ...
        :'max_id' => :'max_ID',
        :'included_benefit_code' => :'included_Benefit_Code'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Vba::PlanMaximumBenefit` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Vba::PlanMaximumBenefit`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'included_benefit_code')
        self.included_benefit_code = attributes[:'included_benefit_code']
      else
        self.included_benefit_code = nil
      end
    end
    ...
    def list_invalid_properties
      ...
      if @included_benefit_code.nil?
        invalid_properties.push('invalid value for "included_benefit_code", included_benefit_code cannot be nil.')
      end

      if @included_benefit_code.to_s.length > 20
        invalid_properties.push('invalid value for "included_benefit_code", the character length must be smaller than or equal to 20.')
      end

      if @included_benefit_code.to_s.length < 1
        invalid_properties.push('invalid value for "included_benefit_code", the character length must be great than or equal to 1.')
      end
    ...
    def valid?
      ...
      return false if @included_benefit_code.nil?
      return false if @included_benefit_code.to_s.length > 20
      return false if @included_benefit_code.to_s.length < 1
      true
    end
    ...
    # Custom attribute writer method with validation
    # @param [Object] included_benefit_code Value to be assigned
    def included_benefit_code=(included_benefit_code)
      if included_benefit_code.nil?
        fail ArgumentError, 'included_benefit_code cannot be nil'
      end

      if included_benefit_code.to_s.length > 20
        fail ArgumentError, 'invalid value for "included_benefit_code", the character length must be smaller than or equal to 20.'
      end

      if included_benefit_code.to_s.length < 1
        fail ArgumentError, 'invalid value for "included_benefit_code", the character length must be great than or equal to 1.'
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          max_id == o.max_id &&
          included_benefit_code == o.included_benefit_code
    end
    ...
    def hash
      [plan_id, benefit_code, max_id, included_benefit_code].hash
    end
