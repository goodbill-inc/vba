...
module Vba
  class PremInvoiceSubscriberDetail
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Vba::PremInvoiceSubscriberDetail` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Vba::PremInvoiceSubscriberDetail`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def list_invalid_properties
      ...
      if @premium_waived.nil?
        invalid_properties.push('invalid value for "premium_waived", premium_waived cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @premium_waived.nil?
    ...
    # Custom attribute writer method with validation
    # @param [Object] premium_waived Value to be assigned
    def premium_waived=(premium_waived)
      if premium_waived.nil?
        fail ArgumentError, 'premium_waived cannot be nil'
      end
    ...
    def hash
      [invoice_key, group_id, division_id, subscriber_id, prem_rate_key, dist_volume, entry_date, entry_user, payee_id, premium, premium_received, premium_waived, update_date, update_user, volume].hash
    end
