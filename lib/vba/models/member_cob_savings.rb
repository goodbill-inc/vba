...
module Vba
  class MemberCOBSavings
    # Unique identifier for each COB Savings record for this Member. Note: This field is marked as NOT NULL in the database and therefore required by the API.
    attr_accessor :member_cob_savings_key

    # Allows the User to override the automated COB Savings amount. If the ‘Use COB Savings’ option is selected within ‘Plan Options’, COB Savings auto-populate based upon the ‘COB’ amount.
    ...
    # Group associated with the COB savings override.
    attr_accessor :group_id

    # References Members.Member_Seq value on the parent record.
    attr_accessor :member_seq

    # Identifies the plan type that the COB savings override will be applied to.
    attr_accessor :plan_type

    # Identifies the plan year that the COB savings override will be applied to.
    ...
    def self.attribute_map
      {
        :'member_cob_savings_key' => :'memberCOBSavings_Key',
    ...
    def self.openapi_types
      {
        :'member_cob_savings_key' => :'Integer',
        :'co_b_savings' => :'Float',
        :'entry_date' => :'Time',
        :'entry_user' => :'String',
        :'group_id' => :'String',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Vba::MemberCOBSavings` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Vba::MemberCOBSavings`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'member_cob_savings_key')
        self.member_cob_savings_key = attributes[:'member_cob_savings_key']
      else
        self.member_cob_savings_key = nil
      end
    ...
    def list_invalid_properties
      ...
      if @member_cob_savings_key.nil?
        invalid_properties.push('invalid value for "member_cob_savings_key", member_cob_savings_key cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @member_cob_savings_key.nil?
    ...
    # @param [Object] member_cob_savings_key Value to be assigned
    def member_cob_savings_key=(member_cob_savings_key)
      if member_cob_savings_key.nil?
        fail ArgumentError, 'member_cob_savings_key cannot be nil'
      end

      @member_cob_savings_key = member_cob_savings_key
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          member_cob_savings_key == o.member_cob_savings_key &&
    ...
    def hash
      [member_cob_savings_key, co_b_savings, entry_date, entry_user, group_id, member_seq, plan_type, plan_year, subscriber_id, update_date, update_user].hash
    end
