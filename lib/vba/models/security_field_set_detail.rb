  ...
  class SecurityFieldSetDetail
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Vba::SecurityFieldSetDetail` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Vba::SecurityFieldSetDetail`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'security_field_set_id')
        ...
        self.security_field_set_id = nil
      end
    ...
    def list_invalid_properties
      ...
      if @security_field_set_id.nil?
        invalid_properties.push('invalid value for "security_field_set_id", security_field_set_id cannot be nil.')
      end

      if @security_field_set_id.to_s.length > 32
        invalid_properties.push('invalid value for "security_field_set_id", the character length must be smaller than or equal to 32.')
      end

      if @security_field_set_id.to_s.length < 1
        invalid_properties.push('invalid value for "security_field_set_id", the character length must be great than or equal to 1.')
      end
    ...
    def valid?
      ...
      return false if @security_field_set_id.nil?
      return false if @security_field_set_id.to_s.length > 32
      return false if @security_field_set_id.to_s.length < 1
    ...
    def security_field_set_id=(security_field_set_id)
      if security_field_set_id.nil?
        fail ArgumentError, 'security_field_set_id cannot be nil'
      end
      ...
      if security_field_set_id.to_s.length < 1
        fail ArgumentError, 'invalid value for "security_field_set_id", the character length must be great than or equal to 1.'
      end
    ...
    def hash
      [security_field_set_id, security_field_id, entry_date, entry_user, field_access, field_mask, update_date, update_user].hash
    end
