...
module Vba
  class SubscriberReimbursement
    ...
    attr_accessor :subscriber_reimbursement_key
    ...
    def self.attribute_map
      {
        :'subscriber_reimbursement_key' => :'subscriberReimbursement_Key',
    ...
    def self.openapi_types
      {
        :'subscriber_reimbursement_key' => :'Integer',
        :'benefit_code' => :'String',
        :'effective_date' => :'Time',
        :'entry_date' => :'Time',
        :'entry_user' => :'String',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Vba::SubscriberReimbursement` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Vba::SubscriberReimbursement`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'subscriber_reimbursement_key')
        self.subscriber_reimbursement_key = attributes[:'subscriber_reimbursement_key']
      else
        self.subscriber_reimbursement_key = nil
      end
    ...
    def list_invalid_properties
      ...
      if @subscriber_reimbursement_key.nil?
        invalid_properties.push('invalid value for "subscriber_reimbursement_key", subscriber_reimbursement_key cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @subscriber_reimbursement_key.nil?
    ...
    # @param [Object] subscriber_reimbursement_key Value to be assigned
    def subscriber_reimbursement_key=(subscriber_reimbursement_key)
      if subscriber_reimbursement_key.nil?
        fail ArgumentError, 'subscriber_reimbursement_key cannot be nil'
      end

      @subscriber_reimbursement_key = subscriber_reimbursement_key
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          subscriber_reimbursement_key == o.subscriber_reimbursement_key &&
    ...
    def hash
      [subscriber_reimbursement_key, benefit_code, effective_date, entry_date, entry_user, group_id, max_id, plan_id, term_date, update_date, update_user].hash
    end
