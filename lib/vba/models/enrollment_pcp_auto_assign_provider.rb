...
module Vba
  class EnrollmentPCPAutoAssignProvider
    ...
    attr_accessor :member_provider_count
    ...
    def self.attribute_map
      {
        ...
        :'member_provider_count' => :'member_Provider_Count'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Vba::EnrollmentPCPAutoAssignProvider` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Vba::EnrollmentPCPAutoAssignProvider`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'member_provider_count')
        self.member_provider_count = attributes[:'member_provider_count']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          member_provider_count == o.member_provider_count
    end
    ...
    def hash
      [provider_id, zip_code, practice_type, network_id, accepting_patients, specialty_code, effective_date, expiration_date, accepting_age_from, accepting_age_thru, member_provider_count].hash
    end
