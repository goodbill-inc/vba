...
module Vba
  class SubscriberWaivePremium
    ...
    attr_accessor :subscriber_waive_premium_key
    ...
    def self.attribute_map
      {
        :'subscriber_waive_premium_key' => :'subscriberWaivePremium_Key',
    ...
    def self.openapi_types
      {
        :'subscriber_waive_premium_key' => :'Integer',
        :'benefit_code' => :'String',
        :'effective_date' => :'Time',
        :'entry_date' => :'Time',
        :'entry_user' => :'String',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Vba::SubscriberWaivePremium` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Vba::SubscriberWaivePremium`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'subscriber_waive_premium_key')
        self.subscriber_waive_premium_key = attributes[:'subscriber_waive_premium_key']
      else
        self.subscriber_waive_premium_key = nil
      end
    ...
    def list_invalid_properties
      ...
      if @subscriber_waive_premium_key.nil?
        invalid_properties.push('invalid value for "subscriber_waive_premium_key", subscriber_waive_premium_key cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @subscriber_waive_premium_key.nil?
    ...
    # @param [Object] subscriber_waive_premium_key Value to be assigned
    def subscriber_waive_premium_key=(subscriber_waive_premium_key)
      if subscriber_waive_premium_key.nil?
        fail ArgumentError, 'subscriber_waive_premium_key cannot be nil'
      end

      @subscriber_waive_premium_key = subscriber_waive_premium_key
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          subscriber_waive_premium_key == o.subscriber_waive_premium_key &&
    ...
    def hash
      [subscriber_waive_premium_key, benefit_code, effective_date, entry_date, entry_user, ex_code, plan_id, subscriber_id, term_date, update_date, update_user].hash
    end
