...
module Vba
  class GroupAccountPeriod
    ...
    attr_accessor :group_account_period_key
    ...
    def self.attribute_map
      {
        :'group_account_period_key' => :'groupAccountPeriod_Key',
    ...
    def self.openapi_types
      {
        :'group_account_period_key' => :'Integer',
        :'division_id' => :'String',
        :'effective_date' => :'Time',
        :'entry_date' => :'Time',
        :'entry_user' => :'String',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Vba::GroupAccountPeriod` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Vba::GroupAccountPeriod`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'group_account_period_key')
        self.group_account_period_key = attributes[:'group_account_period_key']
      else
        self.group_account_period_key = nil
      end
    ...
    def list_invalid_properties
      ...
      if @group_account_period_key.nil?
        invalid_properties.push('invalid value for "group_account_period_key", group_account_period_key cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @group_account_period_key.nil?
    ...
    # @param [Object] group_account_period_key Value to be assigned
    def group_account_period_key=(group_account_period_key)
      if group_account_period_key.nil?
        fail ArgumentError, 'group_account_period_key cannot be nil'
      end

      @group_account_period_key = group_account_period_key
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          group_account_period_key == o.group_account_period_key &&
    ...
    def hash
      [group_account_period_key, division_id, effective_date, entry_date, entry_user, group_id, term_date, update_date, update_user].hash
    end
