...
module Vba
  class PremRateMinMax
    attr_accessor :prem_rate_min_max_key
    ...
    attr_accessor :min_max

    attr_accessor :min_max_value
    ...
    def self.attribute_map
      {
        :'prem_rate_min_max_key' => :'premRateMinMax_Key',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Vba::PremRateMinMax` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Vba::PremRateMinMax`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'prem_rate_min_max_key')
        self.prem_rate_min_max_key = attributes[:'prem_rate_min_max_key']
      else
        self.prem_rate_min_max_key = nil
      end
      ...
      if attributes.key?(:'min_max')
        self.min_max = attributes[:'min_max']
      end

      if attributes.key?(:'min_max_value')
        self.min_max_value = attributes[:'min_max_value']
      end
    ...
    def list_invalid_properties
      ...
      if @prem_rate_min_max_key.nil?
        invalid_properties.push('invalid value for "prem_rate_min_max_key", prem_rate_min_max_key cannot be nil.')
      end
      ...
      if !@min_max.nil? && @min_max.to_s.length > 1
        invalid_properties.push('invalid value for "min_max", the character length must be smaller than or equal to 1.')
      end
    ...
    def valid?
      ...
      return false if @prem_rate_min_max_key.nil?
      ...
      return false if !@min_max.nil? && @min_max.to_s.length > 1
    ...
    # @param [Object] prem_rate_min_max_key Value to be assigned
    def prem_rate_min_max_key=(prem_rate_min_max_key)
      if prem_rate_min_max_key.nil?
        fail ArgumentError, 'prem_rate_min_max_key cannot be nil'
      end

      @prem_rate_min_max_key = prem_rate_min_max_key
    end
    ...
    # Custom attribute writer method with validation
    # @param [Object] min_max Value to be assigned
    def min_max=(min_max)
      if !min_max.nil? && min_max.to_s.length > 1
        fail ArgumentError, 'invalid value for "min_max", the character length must be smaller than or equal to 1.'
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          prem_rate_min_max_key == o.prem_rate_min_max_key &&
    ...
    def hash
      [prem_rate_min_max_key, adjustment_reason, description, division_id, effective_date, entry_date, entry_user, group_id, min_max, min_max_value, subscriber_id, term_date, update_date, update_user].hash
    end
