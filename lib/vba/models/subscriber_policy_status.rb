  ...
  class SubscriberPolicyStatus
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Vba::SubscriberPolicyStatus` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Vba::SubscriberPolicyStatus`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'policy_status')
        self.policy_status = attributes[:'policy_status']
      else
        self.policy_status = nil
      end
    ...
    def list_invalid_properties
      ...
      if @policy_status.nil?
        invalid_properties.push('invalid value for "policy_status", policy_status cannot be nil.')
      end

      if @policy_status.to_s.length > 32
        invalid_properties.push('invalid value for "policy_status", the character length must be smaller than or equal to 32.')
      end

      if @policy_status.to_s.length < 1
        invalid_properties.push('invalid value for "policy_status", the character length must be great than or equal to 1.')
      end
    ...
    def valid?
      ...
      return false if @policy_status.nil?
      return false if @policy_status.to_s.length > 32
      return false if @policy_status.to_s.length < 1
    ...
    # Custom attribute writer method with validation
    # @param [Object] policy_status Value to be assigned
    def policy_status=(policy_status)
      if policy_status.nil?
        fail ArgumentError, 'policy_status cannot be nil'
      end

      if policy_status.to_s.length > 32
        fail ArgumentError, 'invalid value for "policy_status", the character length must be smaller than or equal to 32.'
      end

      if policy_status.to_s.length < 1
        fail ArgumentError, 'invalid value for "policy_status", the character length must be great than or equal to 1.'
      end
    ...
    def hash
      [subscriber_id, plan_id, benefit_code, policy_number, policy_status, effective_date, entry_date, entry_user, term_date, update_date, update_user].hash
    end
