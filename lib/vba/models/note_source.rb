  ...
  class NoteSource
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Vba::NoteSource` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Vba::NoteSource`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def hash
      [source_key, column_name1, column_name2, column_name3, column_name4, column_name5, column_type1, column_type2, column_type3, column_type4, column_type5, entry_date, entry_user, key_value1, key_value2, key_value3, key_value4, key_value5, navigate_object, note_key, update_date, update_user].hash
    end
