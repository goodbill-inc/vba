...
module Vba
  class ProviderCredLicense
    ...
    attr_accessor :provider_cred_license_key

    # Indicates the type of license associated with the credential.
    attr_accessor :cred_license_type_key
    ...
    def self.attribute_map
      {
        :'provider_cred_license_key' => :'providerCredLicense_Key',
        :'cred_license_type_key' => :'credLicenseType_Key',
    ...
    def self.openapi_types
      {
        :'provider_cred_license_key' => :'Integer',
        :'cred_license_type_key' => :'Integer',
        :'effective_date' => :'Time',
        :'entry_date' => :'Time',
        :'entry_user' => :'String',
        :'license_name' => :'String',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Vba::ProviderCredLicense` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Vba::ProviderCredLicense`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'provider_cred_license_key')
        self.provider_cred_license_key = attributes[:'provider_cred_license_key']
      else
        self.provider_cred_license_key = nil
      end

      if attributes.key?(:'cred_license_type_key')
        self.cred_license_type_key = attributes[:'cred_license_type_key']
      end
      ...
      if attributes.key?(:'license_name')
        self.license_name = attributes[:'license_name']
      end
    ...
    def list_invalid_properties
      ...
      if @provider_cred_license_key.nil?
        invalid_properties.push('invalid value for "provider_cred_license_key", provider_cred_license_key cannot be nil.')
      end
      ...
      if !@license_name.nil? && @license_name.to_s.length > 512
        invalid_properties.push('invalid value for "license_name", the character length must be smaller than or equal to 512.')
      end

      if !@license_number.nil? && @license_number.to_s.length > 50
        invalid_properties.push('invalid value for "license_number", the character length must be smaller than or equal to 50.')
      end
    ...
    def valid?
      ...
      return false if @provider_cred_license_key.nil?
      return false if !@entry_user.nil? && @entry_user.to_s.length > 20
      return false if !@license_name.nil? && @license_name.to_s.length > 512
      return false if !@license_number.nil? && @license_number.to_s.length > 50
    ...
    # @param [Object] provider_cred_license_key Value to be assigned
    def provider_cred_license_key=(provider_cred_license_key)
      if provider_cred_license_key.nil?
        fail ArgumentError, 'provider_cred_license_key cannot be nil'
      end

      @provider_cred_license_key = provider_cred_license_key
    end
    ...
    # Custom attribute writer method with validation
    # @param [Object] license_name Value to be assigned
    def license_name=(license_name)
      if !license_name.nil? && license_name.to_s.length > 512
        fail ArgumentError, 'invalid value for "license_name", the character length must be smaller than or equal to 512.'
      end
    ...
    def license_number=(license_number)
      if !license_number.nil? && license_number.to_s.length > 50
        fail ArgumentError, 'invalid value for "license_number", the character length must be smaller than or equal to 50.'
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          provider_cred_license_key == o.provider_cred_license_key &&
          cred_license_type_key == o.cred_license_type_key &&
    ...
    def hash
      [provider_cred_license_key, cred_license_type_key, effective_date, entry_date, entry_user, license_name, license_number, ps_v_date, provider_cred_key, specialty_code, state, term_date, update_date, update_user].hash
    end
