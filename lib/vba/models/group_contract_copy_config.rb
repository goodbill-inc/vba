...
module Vba
  class GroupContractCopyConfig
    ...
    attr_accessor :apply_division_id
    ...
    def self.attribute_map
      {
        ...
        :'apply_division_id' => :'apply_Division_ID',
        :'user_id' => :'user_ID'
      }
    end
    ...
    def self.openapi_types
      {
        ...
        :'division_id' => :'String',
        :'coverage_start' => :'Time',
        :'apply_division_id' => :'Array<String>',
        :'user_id' => :'String'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Vba::GroupContractCopyConfig` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Vba::GroupContractCopyConfig`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'apply_division_id')
        if (value = attributes[:'apply_division_id']).is_a?(Array)
          self.apply_division_id = value
        end
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          apply_division_id == o.apply_division_id &&
          user_id == o.user_id
    end
    ...
    def hash
      [group_id, division_id, coverage_start, apply_division_id, user_id].hash
    end
