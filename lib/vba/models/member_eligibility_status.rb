...
module Vba
  class MemberEligibilityStatus
    ...
    attr_accessor :member_eligibility_status_key
    ...
    def self.attribute_map
      {
        :'member_eligibility_status_key' => :'memberEligibilityStatus_Key',
    ...
    def self.openapi_types
      {
        :'member_eligibility_status_key' => :'Integer',
        :'effective_date' => :'Time',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Vba::MemberEligibilityStatus` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Vba::MemberEligibilityStatus`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'member_eligibility_status_key')
        self.member_eligibility_status_key = attributes[:'member_eligibility_status_key']
      else
        self.member_eligibility_status_key = nil
      end
    ...
    def list_invalid_properties
      ...
      if @member_eligibility_status_key.nil?
        invalid_properties.push('invalid value for "member_eligibility_status_key", member_eligibility_status_key cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @member_eligibility_status_key.nil?
    ...
    # @param [Object] member_eligibility_status_key Value to be assigned
    def member_eligibility_status_key=(member_eligibility_status_key)
      if member_eligibility_status_key.nil?
        fail ArgumentError, 'member_eligibility_status_key cannot be nil'
      end

      @member_eligibility_status_key = member_eligibility_status_key
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          member_eligibility_status_key == o.member_eligibility_status_key &&
    ...
    def hash
      [member_eligibility_status_key, effective_date, eligibility_status, end_date, entry_date, entry_user, member_seq, subscriber_id, update_date, update_user].hash
    end
