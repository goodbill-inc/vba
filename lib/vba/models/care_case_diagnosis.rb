...
module Vba
  class CareCaseDiagnosis
    attr_accessor :care_case_diagnosis_key

    attr_accessor :case_key

    attr_accessor :comment

    attr_accessor :diag_stage
    ...
    def self.attribute_map
      {
        :'care_case_diagnosis_key' => :'careCaseDiagnosis_Key',
        :'case_key' => :'case_Key',
        :'comment' => :'comment',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Vba::CareCaseDiagnosis` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Vba::CareCaseDiagnosis`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'care_case_diagnosis_key')
        self.care_case_diagnosis_key = attributes[:'care_case_diagnosis_key']
      else
        self.care_case_diagnosis_key = nil
      end
      ...
      if attributes.key?(:'diag_stage')
        self.diag_stage = attributes[:'diag_stage']
      end
    ...
    def list_invalid_properties
      ...
      if @care_case_diagnosis_key.nil?
        invalid_properties.push('invalid value for "care_case_diagnosis_key", care_case_diagnosis_key cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @care_case_diagnosis_key.nil?
    ...
    # @param [Object] care_case_diagnosis_key Value to be assigned
    def care_case_diagnosis_key=(care_case_diagnosis_key)
      if care_case_diagnosis_key.nil?
        fail ArgumentError, 'care_case_diagnosis_key cannot be nil'
      end

      @care_case_diagnosis_key = care_case_diagnosis_key
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          care_case_diagnosis_key == o.care_case_diagnosis_key &&
          case_key == o.case_key &&
          comment == o.comment &&
          diag_stage == o.diag_stage &&
    ...
    def hash
      [care_case_diagnosis_key, case_key, comment, diag_stage, diagnostic_code, diagnostic_group, effective_date, entry_date, entry_user, term_date, update_date, update_user].hash
    end
