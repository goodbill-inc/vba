  ...
  class VBAProcess
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Vba::VBAProcess` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Vba::VBAProcess`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'process_end')
        self.process_end = attributes[:'process_end']
      end

      if attributes.key?(:'process_result')
        self.process_result = attributes[:'process_result']
      end

      if attributes.key?(:'process_start')
        self.process_start = attributes[:'process_start']
      end
    ...
    def list_invalid_properties
      ...
      if !@process_result.nil? && @process_result.to_s.length > 32
        invalid_properties.push('invalid value for "process_result", the character length must be smaller than or equal to 32.')
      end

      if !@process_user.nil? && @process_user.to_s.length > 20
        invalid_properties.push('invalid value for "process_user", the character length must be smaller than or equal to 20.')
      end
    ...
    def valid?
      ...
      return false if !@process_result.nil? && @process_result.to_s.length > 32
      return false if !@process_user.nil? && @process_user.to_s.length > 20
    ...
    # Custom attribute writer method with validation
    # @param [Object] process_result Value to be assigned
    def process_result=(process_result)
      if !process_result.nil? && process_result.to_s.length > 32
        fail ArgumentError, 'invalid value for "process_result", the character length must be smaller than or equal to 32.'
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] process_user Value to be assigned
    def process_user=(process_user)
      if !process_user.nil? && process_user.to_s.length > 20
        fail ArgumentError, 'invalid value for "process_user", the character length must be smaller than or equal to 20.'
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          process_end == o.process_end &&
          process_result == o.process_result &&
          process_start == o.process_start &&
    ...
    def hash
      [vba_process_key, vba_process_type, description, entry_date, entry_user, process_end, process_result, process_start, process_user, update_date, update_user].hash
    end
