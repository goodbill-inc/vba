...
module Vba
  class VBAInterfaceMapType
    ...
    # System Configuration Values used by VBA Engineers to group EDICode Map Types with similar functionality.
    attr_accessor :surrogate_map_type
    ...
    def self.attribute_map
      {
        ...
        :'surrogate_map_type' => :'surrogate_Map_Type',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Vba::VBAInterfaceMapType` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Vba::VBAInterfaceMapType`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'surrogate_map_type')
        self.surrogate_map_type = attributes[:'surrogate_map_type']
      end
    ...
    def list_invalid_properties
      ...
      if !@surrogate_map_type.nil? && @surrogate_map_type.to_s.length > 16
        invalid_properties.push('invalid value for "surrogate_map_type", the character length must be smaller than or equal to 16.')
      end
    ...
    def valid?
      ...
      return false if !@surrogate_map_type.nil? && @surrogate_map_type.to_s.length > 16
    ...
    # Custom attribute writer method with validation
    # @param [Object] surrogate_map_type Value to be assigned
    def surrogate_map_type=(surrogate_map_type)
      if !surrogate_map_type.nil? && surrogate_map_type.to_s.length > 16
        fail ArgumentError, 'invalid value for "surrogate_map_type", the character length must be smaller than or equal to 16.'
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          surrogate_map_type == o.surrogate_map_type &&
    ...
    def hash
      [vba_interface_key, map_type, description, entry_date, entry_user, surrogate_map_type, update_date, update_user].hash
    end
