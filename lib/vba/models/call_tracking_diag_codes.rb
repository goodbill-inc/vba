...
module Vba
  class CallTrackingDiagCodes
    ...
    attr_accessor :call_tracking_diag_codes_key
    ...
    def self.attribute_map
      {
        :'call_tracking_diag_codes_key' => :'callTrackingDiagCodes_Key',
        :'call_key' => :'call_Key',
    ...
    def self.openapi_types
      {
        :'call_tracking_diag_codes_key' => :'Integer',
        :'call_key' => :'Integer',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Vba::CallTrackingDiagCodes` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Vba::CallTrackingDiagCodes`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'call_tracking_diag_codes_key')
        self.call_tracking_diag_codes_key = attributes[:'call_tracking_diag_codes_key']
      else
        self.call_tracking_diag_codes_key = nil
      end
    ...
    def list_invalid_properties
      ...
      if @call_tracking_diag_codes_key.nil?
        invalid_properties.push('invalid value for "call_tracking_diag_codes_key", call_tracking_diag_codes_key cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @call_tracking_diag_codes_key.nil?
    ...
    # @param [Object] call_tracking_diag_codes_key Value to be assigned
    def call_tracking_diag_codes_key=(call_tracking_diag_codes_key)
      if call_tracking_diag_codes_key.nil?
        fail ArgumentError, 'call_tracking_diag_codes_key cannot be nil'
      end

      @call_tracking_diag_codes_key = call_tracking_diag_codes_key
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          call_tracking_diag_codes_key == o.call_tracking_diag_codes_key &&
          call_key == o.call_key &&
    ...
    def hash
      [call_tracking_diag_codes_key, call_key, diagnostic_code, diagnostic_code_type, effective_date, entry_date, entry_user, update_date, update_user].hash
    end
