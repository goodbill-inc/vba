...
module Vba
  class ContactPhone
    ...
    attr_accessor :contact_phone_key
    ...
    def self.attribute_map
      {
        :'contact_phone_key' => :'contactPhone_Key',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Vba::ContactPhone` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Vba::ContactPhone`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'contact_phone_key')
        self.contact_phone_key = attributes[:'contact_phone_key']
      else
        self.contact_phone_key = nil
      end
    ...
    def list_invalid_properties
      ...
      if @contact_phone_key.nil?
        invalid_properties.push('invalid value for "contact_phone_key", contact_phone_key cannot be nil.')
      end
      ...
      if @phone_type.to_s.length > 16
        invalid_properties.push('invalid value for "phone_type", the character length must be smaller than or equal to 16.')
      end

      if @phone_type.to_s.length < 1
        invalid_properties.push('invalid value for "phone_type", the character length must be great than or equal to 1.')
      end
    ...
    def valid?
      ...
      return false if @contact_phone_key.nil?
      ...
      return false if @phone_type.to_s.length > 16
      return false if @phone_type.to_s.length < 1
      return false if !@update_user.nil? && @update_user.to_s.length > 20
      true
    end

    # Custom attribute writer method with validation
    # @param [Object] contact_phone_key Value to be assigned
    def contact_phone_key=(contact_phone_key)
      if contact_phone_key.nil?
        fail ArgumentError, 'contact_phone_key cannot be nil'
      end

      @contact_phone_key = contact_phone_key
    end
    ...
    # Custom attribute writer method with validation
    # @param [Object] phone_type Value to be assigned
    def phone_type=(phone_type)
      if phone_type.nil?
        fail ArgumentError, 'phone_type cannot be nil'
      end

      if phone_type.to_s.length > 16
        fail ArgumentError, 'invalid value for "phone_type", the character length must be smaller than or equal to 16.'
      end

      if phone_type.to_s.length < 1
        fail ArgumentError, 'invalid value for "phone_type", the character length must be great than or equal to 1.'
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          contact_phone_key == o.contact_phone_key &&
    ...
    def hash
      [contact_phone_key, contact_key, entry_date, entry_user, phone_country_code, phone_number, phone_type, update_date, update_user].hash
    end
