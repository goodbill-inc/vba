...
module Vba
  class PayorAccountSignature
    ...
    attr_accessor :payor_account_signature_key
    ...
    def self.attribute_map
      {
        :'payor_account_signature_key' => :'payorAccountSignature_Key',
    ...
    def self.openapi_types
      {
        :'payor_account_signature_key' => :'Integer',
        :'effective_date' => :'Time',
        :'entry_date' => :'Time',
        :'entry_user' => :'String',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Vba::PayorAccountSignature` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Vba::PayorAccountSignature`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'payor_account_signature_key')
        self.payor_account_signature_key = attributes[:'payor_account_signature_key']
      else
        self.payor_account_signature_key = nil
      end
    ...
    def list_invalid_properties
      ...
      if @payor_account_signature_key.nil?
        invalid_properties.push('invalid value for "payor_account_signature_key", payor_account_signature_key cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @payor_account_signature_key.nil?
    ...
    # @param [Object] payor_account_signature_key Value to be assigned
    def payor_account_signature_key=(payor_account_signature_key)
      if payor_account_signature_key.nil?
        fail ArgumentError, 'payor_account_signature_key cannot be nil'
      end

      @payor_account_signature_key = payor_account_signature_key
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          payor_account_signature_key == o.payor_account_signature_key &&
    ...
    def hash
      [payor_account_signature_key, effective_date, entry_date, entry_user, payor_account_key, required, signature_key, term_date, update_date, update_user].hash
    end
