...
module Vba
  class MemberAddressHistory
    ...
    attr_accessor :member_address_history_key
    ...
    def self.attribute_map
      {
        :'member_address_history_key' => :'memberAddressHistory_Key',
        :'address' => :'address',
        :'address2' => :'address2',
    ...
    def self.openapi_types
      {
        :'member_address_history_key' => :'Integer',
        :'address' => :'String',
        :'address2' => :'String',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Vba::MemberAddressHistory` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Vba::MemberAddressHistory`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'member_address_history_key')
        self.member_address_history_key = attributes[:'member_address_history_key']
      else
        self.member_address_history_key = nil
      end
    ...
    def list_invalid_properties
      ...
      if @member_address_history_key.nil?
        invalid_properties.push('invalid value for "member_address_history_key", member_address_history_key cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @member_address_history_key.nil?
    ...
    # @param [Object] member_address_history_key Value to be assigned
    def member_address_history_key=(member_address_history_key)
      if member_address_history_key.nil?
        fail ArgumentError, 'member_address_history_key cannot be nil'
      end

      @member_address_history_key = member_address_history_key
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          member_address_history_key == o.member_address_history_key &&
          address == o.address &&
          address2 == o.address2 &&
    ...
    def hash
      [member_address_history_key, address, address2, cell_country_code, cell_phone, city, country_id, county_code, effective_date, email_address, entry_date, entry_user, home_country_code, home_phone, latitude, longitude, member_seq, region_code, secondary_address, secondary_address2, secondary_city, secondary_county_code, secondary_state, secondary_zip_code, state, subscriber_id, term_date, update_date, update_user, work_country_code, work_phone, zip_code].hash
    end
