...
module Vba
  class MemberOccupation
    ...
    attr_accessor :pay_rate_frequency
    ...
    def self.attribute_map
      {
        ...
        :'hire_date' => :'hire_Date',
        :'pay_rate' => :'pay_Rate',
        :'pay_rate_frequency' => :'pay_Rate_Frequency',
        :'term_date' => :'term_Date',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Vba::MemberOccupation` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Vba::MemberOccupation`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'pay_rate_frequency')
        self.pay_rate_frequency = attributes[:'pay_rate_frequency']
      end
    ...
    def list_invalid_properties
      ...
      if !@pay_rate_frequency.nil? && @pay_rate_frequency.to_s.length > 16
        invalid_properties.push('invalid value for "pay_rate_frequency", the character length must be smaller than or equal to 16.')
      end
    ...
    def valid?
      ...
      return false if !@pay_rate_frequency.nil? && @pay_rate_frequency.to_s.length > 16
    ...
    # Custom attribute writer method with validation
    # @param [Object] pay_rate_frequency Value to be assigned
    def pay_rate_frequency=(pay_rate_frequency)
      if !pay_rate_frequency.nil? && pay_rate_frequency.to_s.length > 16
        fail ArgumentError, 'invalid value for "pay_rate_frequency", the character length must be smaller than or equal to 16.'
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          pay_rate == o.pay_rate &&
          pay_rate_frequency == o.pay_rate_frequency &&
    ...
    def hash
      [subscriber_id, member_seq, occupation_id, effective_date, entry_date, entry_user, hire_date, pay_rate, pay_rate_frequency, term_date, update_date, update_user].hash
    end
