...
module Vba
  class MemberIDCardPrinted
    ...
    # References ReportDefinition.ReportDefinition_Key for this report. Note: This field is marked as NOT NULL in the database and therefore required by the API.
    attr_accessor :report_definition_key

    # Date when the ID Card was printed. Note: This field is marked as NOT NULL in the database and therefore required by the API.
    attr_accessor :printed_date
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Vba::MemberIDCardPrinted` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Vba::MemberIDCardPrinted`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'printed_date')
        self.printed_date = attributes[:'printed_date']
      else
        self.printed_date = nil
      end
    ...
    def list_invalid_properties
      ...
      if @printed_date.nil?
        invalid_properties.push('invalid value for "printed_date", printed_date cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @printed_date.nil?
    ...
    # Custom attribute writer method with validation
    # @param [Object] printed_date Value to be assigned
    def printed_date=(printed_date)
      if printed_date.nil?
        fail ArgumentError, 'printed_date cannot be nil'
      end
    ...
    def hash
      [subscriber_id, member_seq, report_definition_key, printed_date, entry_date, entry_user, update_date, update_user].hash
    end
