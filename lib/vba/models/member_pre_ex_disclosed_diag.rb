...
module Vba
  class MemberPreExDisclosedDiag
    ...
    attr_accessor :member_pre_ex_disclosed_diag_key
    ...
    def self.attribute_map
      {
        :'member_pre_ex_disclosed_diag_key' => :'memberPreExDisclosedDiag_Key',
    ...
    def self.openapi_types
      {
        :'member_pre_ex_disclosed_diag_key' => :'Integer',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Vba::MemberPreExDisclosedDiag` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Vba::MemberPreExDisclosedDiag`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'member_pre_ex_disclosed_diag_key')
        self.member_pre_ex_disclosed_diag_key = attributes[:'member_pre_ex_disclosed_diag_key']
      else
        self.member_pre_ex_disclosed_diag_key = nil
      end
    ...
    def list_invalid_properties
      ...
      if @member_pre_ex_disclosed_diag_key.nil?
        invalid_properties.push('invalid value for "member_pre_ex_disclosed_diag_key", member_pre_ex_disclosed_diag_key cannot be nil.')
      end
      ...
      if !@from_diag.nil? && @from_diag.to_s.length > 8
      ...
      if !@thru_diag.nil? && @thru_diag.to_s.length > 8
    ...
    def valid?
      ...
      return false if @member_pre_ex_disclosed_diag_key.nil?
      ...
      return false if !@from_diag.nil? && @from_diag.to_s.length > 8
      ...
      return false if !@thru_diag.nil? && @thru_diag.to_s.length > 8
      return false if !@update_user.nil? && @update_user.to_s.length > 20
      true
    end

    # Custom attribute writer method with validation
    # @param [Object] member_pre_ex_disclosed_diag_key Value to be assigned
    def member_pre_ex_disclosed_diag_key=(member_pre_ex_disclosed_diag_key)
      if member_pre_ex_disclosed_diag_key.nil?
        fail ArgumentError, 'member_pre_ex_disclosed_diag_key cannot be nil'
      end

      @member_pre_ex_disclosed_diag_key = member_pre_ex_disclosed_diag_key
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          member_pre_ex_disclosed_diag_key == o.member_pre_ex_disclosed_diag_key &&
    ...
    def hash
      [member_pre_ex_disclosed_diag_key, diagnostic_code_type, diagnostic_group, entry_date, entry_user, from_diag, member_seq, subscriber_id, thru_diag, update_date, update_user].hash
    end
