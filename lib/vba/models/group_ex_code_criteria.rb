...
module Vba
  class GroupExCodeCriteria
    ...
    def self.attribute_map
      {
        :'group_ex_code_criteria_key' => :'groupExCodeCriteria_Key',
        :'criteria_from' => :'criteria_From',
        :'criteria_operator' => :'criteria_Operator',
        :'criteria_thru' => :'criteria_Thru',
        :'division_id' => :'division_ID',
        :'e_x_code' => :'eX_Code',
        :'group_ex_code_criteria_column_key' => :'groupExCodeCriteriaColumn_Key',
        :'group_id' => :'group_ID'
      }
    end
    ...
    def self.openapi_types
      {
        :'group_ex_code_criteria_key' => :'Integer',
        :'criteria_from' => :'String',
        :'criteria_operator' => :'String',
        :'criteria_thru' => :'String',
        :'division_id' => :'String',
        :'e_x_code' => :'String',
        :'group_ex_code_criteria_column_key' => :'Integer',
        :'group_id' => :'String'
      }
    end
    ...
    def self.openapi_nullable
      Set.new([
        ...
        :'division_id',
        :'e_x_code',
        :'group_ex_code_criteria_column_key',
        :'group_id'
      ])
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Vba::GroupExCodeCriteria` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Vba::GroupExCodeCriteria`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'group_ex_code_criteria_key')
        self.group_ex_code_criteria_key = attributes[:'group_ex_code_criteria_key']
      else
        self.group_ex_code_criteria_key = nil
      end
      ...
      if attributes.key?(:'e_x_code')
        self.e_x_code = attributes[:'e_x_code']
      end

      if attributes.key?(:'group_ex_code_criteria_column_key')
        self.group_ex_code_criteria_column_key = attributes[:'group_ex_code_criteria_column_key']
      end
    ...
    def list_invalid_properties
      ...
      if @group_ex_code_criteria_key.nil?
        invalid_properties.push('invalid value for "group_ex_code_criteria_key", group_ex_code_criteria_key cannot be nil.')
      end
      ...
      if !@e_x_code.nil? && @e_x_code.to_s.length > 6
        invalid_properties.push('invalid value for "e_x_code", the character length must be smaller than or equal to 6.')
      end
    ...
    def valid?
      ...
      return false if @group_ex_code_criteria_key.nil?
      ...
      return false if !@e_x_code.nil? && @e_x_code.to_s.length > 6
      return false if !@group_id.nil? && @group_id.to_s.length > 20
      true
    end

    # Custom attribute writer method with validation
    # @param [Object] group_ex_code_criteria_key Value to be assigned
    def group_ex_code_criteria_key=(group_ex_code_criteria_key)
      if group_ex_code_criteria_key.nil?
        fail ArgumentError, 'group_ex_code_criteria_key cannot be nil'
      end

      @group_ex_code_criteria_key = group_ex_code_criteria_key
    end
    ...
    # Custom attribute writer method with validation
    # @param [Object] e_x_code Value to be assigned
    def e_x_code=(e_x_code)
      if !e_x_code.nil? && e_x_code.to_s.length > 6
        fail ArgumentError, 'invalid value for "e_x_code", the character length must be smaller than or equal to 6.'
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          group_ex_code_criteria_key == o.group_ex_code_criteria_key &&
          criteria_from == o.criteria_from &&
          criteria_operator == o.criteria_operator &&
          criteria_thru == o.criteria_thru &&
          division_id == o.division_id &&
          e_x_code == o.e_x_code &&
          group_ex_code_criteria_column_key == o.group_ex_code_criteria_column_key &&
          group_id == o.group_id
    end
    ...
    def hash
      [group_ex_code_criteria_key, criteria_from, criteria_operator, criteria_thru, division_id, e_x_code, group_ex_code_criteria_column_key, group_id].hash
    end
