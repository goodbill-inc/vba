...
module Vba
  class PaymentMethod
    ...
    attr_accessor :payment_method_ach
    ...
    attr_accessor :payment_method_check
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Vba::PaymentMethod` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Vba::PaymentMethod`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'payment_method_ach')
        self.payment_method_ach = attributes[:'payment_method_ach']
      else
        self.payment_method_ach = nil
      end

      if attributes.key?(:'payment_method_check')
        self.payment_method_check = attributes[:'payment_method_check']
      else
        self.payment_method_check = nil
      end
    ...
    def list_invalid_properties
      ...
      if @payment_method_ach.nil?
        invalid_properties.push('invalid value for "payment_method_ach", payment_method_ach cannot be nil.')
      end

      if @payment_method_check.nil?
        invalid_properties.push('invalid value for "payment_method_check", payment_method_check cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @payment_method_ach.nil?
      return false if @payment_method_check.nil?
    ...
    # Custom attribute writer method with validation
    # @param [Object] payment_method_ach Value to be assigned
    def payment_method_ach=(payment_method_ach)
      if payment_method_ach.nil?
        fail ArgumentError, 'payment_method_ach cannot be nil'
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] payment_method_check Value to be assigned
    def payment_method_check=(payment_method_check)
      if payment_method_check.nil?
        fail ArgumentError, 'payment_method_check cannot be nil'
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          payment_method_ach == o.payment_method_ach &&
          payment_method_check == o.payment_method_check &&
    ...
    def hash
      [payment_method, description, entry_date, entry_user, payment_method_ach, payment_method_check, update_date, update_user].hash
    end
