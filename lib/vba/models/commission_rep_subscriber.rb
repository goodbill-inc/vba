...
module Vba
  class CommissionRepSubscriber
    attr_accessor :commission_rep_subscriber_key
    ...
    def self.attribute_map
      {
        :'commission_rep_subscriber_key' => :'commissionRepSubscriber_Key',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Vba::CommissionRepSubscriber` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Vba::CommissionRepSubscriber`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'commission_rep_subscriber_key')
        self.commission_rep_subscriber_key = attributes[:'commission_rep_subscriber_key']
      else
        self.commission_rep_subscriber_key = nil
      end
    ...
    def list_invalid_properties
      ...
      if @commission_rep_subscriber_key.nil?
        invalid_properties.push('invalid value for "commission_rep_subscriber_key", commission_rep_subscriber_key cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @commission_rep_subscriber_key.nil?
    ...
    # @param [Object] commission_rep_subscriber_key Value to be assigned
    def commission_rep_subscriber_key=(commission_rep_subscriber_key)
      if commission_rep_subscriber_key.nil?
        fail ArgumentError, 'commission_rep_subscriber_key cannot be nil'
      end

      @commission_rep_subscriber_key = commission_rep_subscriber_key
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          commission_rep_subscriber_key == o.commission_rep_subscriber_key &&
    ...
    def hash
      [commission_rep_subscriber_key, commission_rep_key, entry_date, entry_user, subscriber_id, update_date, update_user].hash
    end
