  ...
  class GroupNetwork
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Vba::GroupNetwork` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Vba::GroupNetwork`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'process_as_oon')
        self.process_as_oon = attributes[:'process_as_oon']
      else
        self.process_as_oon = nil
      end
    ...
    def list_invalid_properties
      ...
      if @process_as_oon.nil?
        invalid_properties.push('invalid value for "process_as_oon", process_as_oon cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @process_as_oon.nil?
    ...
    # Custom attribute writer method with validation
    # @param [Object] process_as_oon Value to be assigned
    def process_as_oon=(process_as_oon)
      if process_as_oon.nil?
        fail ArgumentError, 'process_as_oon cannot be nil'
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          priority == o.priority &&
          process_as_oon == o.process_as_oon &&
    ...
    def hash
      [group_id, division_id, coverage_start, network_id, state, ap_c_schedule, claim_days_allowed, dr_g_schedule, eff_date, entry_date, entry_user, network_type, priority, process_as_oon, update_date, update_user].hash
    end
