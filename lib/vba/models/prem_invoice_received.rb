  ...
  class PremInvoiceReceived
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Vba::PremInvoiceReceived` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Vba::PremInvoiceReceived`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'prem_invoice_received_key')
        ...
        self.prem_invoice_received_key = nil
      end
    ...
    def list_invalid_properties
      ...
      if @prem_invoice_received_key.nil?
        invalid_properties.push('invalid value for "prem_invoice_received_key", prem_invoice_received_key cannot be nil.')
      end
      ...
      if @subscriber_id.to_s.length > 20
    ...
    def valid?
      ...
      return false if @prem_invoice_received_key.nil?
      ...
      return false if @subscriber_id.to_s.length > 20
    ...
    # @param [Object] prem_invoice_received_key Value to be assigned
    def prem_invoice_received_key=(prem_invoice_received_key)
      if prem_invoice_received_key.nil?
        fail ArgumentError, 'prem_invoice_received_key cannot be nil'
      end

      @prem_invoice_received_key = prem_invoice_received_key
    end
    ...
    def hash
      [prem_invoice_received_key, division_id, entry_date, entry_user, group_id, invoice_key, prem_payment_key, prem_rate_key, premium_received, premium_received_date, subscriber_id, update_date, update_user].hash
    end
