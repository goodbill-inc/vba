...
module Vba
  class EnrollmentWaitingPeriodSubscriber
    attr_accessor :enrollment_waiting_period_subscriber_key
    ...
    def self.attribute_map
      {
        :'enrollment_waiting_period_subscriber_key' => :'enrollmentWaitingPeriodSubscriber_Key',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Vba::EnrollmentWaitingPeriodSubscriber` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Vba::EnrollmentWaitingPeriodSubscriber`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'enrollment_waiting_period_subscriber_key')
        self.enrollment_waiting_period_subscriber_key = attributes[:'enrollment_waiting_period_subscriber_key']
      else
        self.enrollment_waiting_period_subscriber_key = nil
      end
    ...
    def list_invalid_properties
      ...
      if @enrollment_waiting_period_subscriber_key.nil?
        invalid_properties.push('invalid value for "enrollment_waiting_period_subscriber_key", enrollment_waiting_period_subscriber_key cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @enrollment_waiting_period_subscriber_key.nil?
    ...
    # @param [Object] enrollment_waiting_period_subscriber_key Value to be assigned
    def enrollment_waiting_period_subscriber_key=(enrollment_waiting_period_subscriber_key)
      if enrollment_waiting_period_subscriber_key.nil?
        fail ArgumentError, 'enrollment_waiting_period_subscriber_key cannot be nil'
      end

      @enrollment_waiting_period_subscriber_key = enrollment_waiting_period_subscriber_key
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          enrollment_waiting_period_subscriber_key == o.enrollment_waiting_period_subscriber_key &&
    ...
    def hash
      [enrollment_waiting_period_subscriber_key, date_employed, division_id, entry_date, entry_user, group_id, subscriber_id, update_date, update_user].hash
    end
