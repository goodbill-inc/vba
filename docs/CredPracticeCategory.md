...
| **description** | **String** | Description of the practice category. | [optional] |
| **display** | **String** | Name of the practice category. | [optional] |
...
instance = Vba::CredPracticeCategory.new(
