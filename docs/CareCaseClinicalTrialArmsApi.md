# Vba::CareCaseClinicalTrialArmsApi
...
#### Using the create_care_case_clinical_trial_arm_with_http_info variant
...
#### Using the get_care_case_clinical_trial_arm_with_http_info variant
