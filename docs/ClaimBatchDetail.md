# Vba::ClaimBatchDetail

## Properties

| Name | Type | Description | Notes |
| ---- | ---- | ----------- | ----- |
| **batch_number** | **Integer** | References the ClaimBatch.Batch_Number value on the parent record. Note: This field is marked as NOT NULL in the database and therefore required by the API. |  |
| **batch_claim** | **Integer** | References the ClaimBatch.Batch_Claim value on the parent record. Note: This field is marked as NOT NULL in the database and therefore required by the API. |  |
...
| **adjusted_from_adjustment_line** | **String** | References the Adjustment_Seq value on the original claim that this claim is adjusting. | [optional] |
| **adjusted_from_line** | **String** | References the Claim_Seq value on the original claim that this claim is adjusting. | [optional] |
