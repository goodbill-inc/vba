...
# Unit tests for Vba::SearchCriteriaApi
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'SearchCriteriaApi' do
  before do
  ...
  describe 'test an instance of SearchCriteriaApi' do
    it 'should create an instance of SearchCriteriaApi' do
      expect(@api_instance).to be_instance_of(Vba::SearchCriteriaApi)
    end
  end
